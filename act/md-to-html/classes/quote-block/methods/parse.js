...
/// #{{{ @func QuoteBlock.prototype.parse
/**
 * @public
 * @this {!QuoteBlock}
 * @param {!Html} ROOT
 ...
 * @return {string}
 */
function parseQuoteBlock(ROOT, BLOCK, ELEMS, LINES, LEN, DEPTH) {
  ...
  result = '<blockquote>';
  i = skipBlankLines(LINES, LEN, 0);
  while (i < LEN) {
    blk = newBlock(BLOCK, (i + INDEX), DEPTH);
    result += blk.RESULT;
    ELEMS.push(blk);
...
module.exports = parseQuoteBlock;
