...
/// #{{{ @func OrderedList.prototype.scope
/**
 * @public
 * @this {!OrderedList}
 * @param {!Html} ROOT
 ...
 * @return {!Block}
 */
function scopeOrderedList(ROOT, BLOCK, index, depth) {
   ...
   * @const {!RegExp}
   */
  var PATTERN = new RegExp('^' + getIndent(LINES[0]) + '[0-9]+\\) ');
  /// #}}} @const PATTERN
...
module.exports = scopeOrderedList;
