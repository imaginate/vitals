...
Cond.prototype = createObject(null);
 ...
 * @return {number}
 */
Cond.prototype.parse = function parse(lines, i, file) {
 ...
 * @return {string}
 */
Cond.prototype.run = function run(condFlags, inclFiles, inclNodes) {
 ...
 * @return {void}
 */
Cond.prototype.setClose = function setClose(close) {
