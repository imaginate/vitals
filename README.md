# vitals [![build status](https://travis-ci.org/imaginate/vitals.svg?branch=master)](https://travis-ci.org/imaginate/vitals) [![npm version](https://img.shields.io/badge/npm-4.1.0-brightgreen.svg?style=flat)](https://www.npmjs.com/package/node-vitals)
### Give Your JS Life
