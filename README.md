# vitals [![build status](https://travis-ci.org/imaginate/vitals.svg?branch=v3.0.0)](https://travis-ci.org/imaginate/vitals) [![npm version](https://img.shields.io/badge/npm-3.0.0-yellow.svg?style=flat)](https://www.npmjs.com/package/node-vitals)
### Give Your JS Life
_vitals_ is a foundational JavaScript library designed to replace all native string, object, and array methods (plus fix [poorly designed syntax](http://www.crockford.com/javascript/javascript.html)) with just 15 [base methods](#base-methods). It will improve your project's **readability**, **stability**, and **performance**. Its additional methods allow you to more efficiently utilize [immutability](https://en.wikipedia.org/wiki/Immutable_object), [strong typing](https://en.wikipedia.org/wiki/Strong_and_weak_typing), and [node.js](https://nodejs.org) interactions with the [file system](https://en.wikipedia.org/wiki/File_system) or [shell](https://en.wikipedia.org/wiki/Command-line_interface#Command-line_interpreter). Built with **simplicity** in mind _vitals_ hopes to inspire you to use [functional JavaScript](https://medium.com/javascript-scene/the-two-pillars-of-javascript-pt-2-functional-programming-a63aa53a41a4) in all of your projects!
...
| Documentation                                                                                                 | Examples                                                                                                                 | Alias              |
| :------------------------------------------------------------------------------------------------------------ | :----------------------------------------------------------------------------------------------------------------------- | :----------------- |
| [amend](https://github.com/imaginate/vitals/blob/1ec55a7e80/src/methods/amend.js#L45-L84)                     | [amend](https://github.com/imaginate/vitals/blob/master/test/methods/amend/amend.js)                                     |                    |
| [amend.config](https://github.com/imaginate/vitals/blob/1ec55a7e80/src/methods/amend.js#L136-L150)            | [amend.config](https://github.com/imaginate/vitals/blob/master/test/methods/amend/amend.config.js)                       |                    |
| [amend.property](https://github.com/imaginate/vitals/blob/1ec55a7e80/src/methods/amend.js#L171-L201)          | [amend.property](https://github.com/imaginate/vitals/blob/master/test/methods/amend/amend.property.js)                   | amend.prop         |
| [amend.property.config](https://github.com/imaginate/vitals/blob/1ec55a7e80/src/methods/amend.js#L242-L250)   | [amend.property.config](https://github.com/imaginate/vitals/blob/master/test/methods/amend/amend.property.config.js)     | amend.prop.config  |
| [amend.properties](https://github.com/imaginate/vitals/blob/1ec55a7e80/src/methods/amend.js#L266-L306)        | [amend.properties](https://github.com/imaginate/vitals/blob/master/test/methods/amend/amend.properties.js)               | amend.props        |
| [amend.properties.config](https://github.com/imaginate/vitals/blob/1ec55a7e80/src/methods/amend.js#L360-L374) | [amend.properties.config](https://github.com/imaginate/vitals/blob/master/test/methods/amend/amend.properties.config.js) | amend.props.config |
