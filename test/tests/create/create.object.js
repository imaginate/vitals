...
method('create.object', 'create.obj', function createObjectTests() {
  ...
  should('C', 'make object with prototype, properties, and descriptors', function createObjectTestsC() {
    ...
    /// #{{{ @test C2
    test('C2', [ {}, [ 'a','b' ], 5, '<descriptor>' ], function createObjectTestC2() {
    ...
    /// #{{{ @test C4
    test('C4', [ {}, '<varied-props>', '<descriptor>' ], function createObjectTestC4() {
  ...
  should('D', 'make object with prototype, properties, and strong type check', function createObjectTestsD() {
    ...
    /// #{{{ @test D1
    test('D1', [ {}, { 'a': 1, 'b': 2 }, 'number' ], function createObjectTestD1() {
      ...
      result = vitals.create.object(proto1, props, 'number');
      proto2 = getPrototype(result);
    ...
    /// #{{{ @test D2
    test('D2', [ {}, [ 'a', 'b' ], 5, 'number' ], function createObjectTestD2() {
    ...
    /// #{{{ @test D4
    test('D4', [ {}, '<descriptors>', 'number' ], function createObjectTestD4() {
  ...
  should('E', 'make object with prototype, properties, and setter', function createObjectTestsE() {
    ...
    /// #{{{ @test E1
    test('E1', [ {}, { 'a': 1, 'b': 2 }, '<setter>' ], function createObjectTestE1() {
      ...
      result = vitals.create.object(proto1, props, setter);
      proto2 = getPrototype(result);
    ...
    /// #{{{ @test E2
    test('E2', [ {}, [ 'a', 'b' ], 5, '<setter>' ], function createObjectTestE2() {
    ...
    /// #{{{ @test E4
    test('E4', [ {}, '<descriptors>', '<setter>' ], function createObjectTestE4() {
  ...
  should('F', 'should throw a vitals error', function createObjectTestsF() {
    ...
    /// #{{{ @test F2
    test('F2', [ 'string' ], function createObjectTestF2() {

      throws.type(function() {
        vitals.create.object('string');
      });
    ...
    /// #{{{ @test F4
    test('F4', [ {}, 'a,b,c' ], function createObjectTestF4() {

      throws(function() {
        vitals.create.object({}, 'a,b,c');
      });
    ...
    /// #{{{ @test F5
    test('F5', [ {}, 'a,b,c', 5, 'string' ], function createObjectTestF5() {

      throws.type(function() {
        vitals.create.object({}, 'a,b,c', 5, 'string');
      });
    ...
    /// #{{{ @test F6
    test('F6', [ {}, 'a,b,c', 5, 'number', {} ], function createObjectTestF6() {

      throws.type(function() {
        vitals.create.object({}, 'a,b,c', 5, 'number', {});
      });
