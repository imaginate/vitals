...
method('amend.properties', 'amend.props', function amendPropertiesTests() {
  ...
  /// #{{{ @tests A
  should('A', "update each property's descriptor", function amendPropertiesTestsA() {
    ...
    test('A2', [
      ...
      result = vitals.amend.properties(obj, keys, desc);
    ...
    test('A3', [
      ...
      result = vitals.amend.properties(obj, 'a,b', desc);
    ...
    test('A4', [
      ...
      result = vitals.amend.properties(obj, keys, null);
    ...
    test('A5', [
      ...
      ///   Any owned property from @amend#properties #props that has a value
      ///   of `undefined` is skipped. Due to the *skip*, defining the #props
  ...
  /// #{{{ @tests B
  should('B', 'throw a vitals error', function amendPropertiesTestsB() {

    /// #{{{ @test B1
    test('B1', [], function amendPropertiesTestB1() {
    ...
    test('B2', [
      ...
      throws.type(function() {
        vitals.amend.properties('fail', 'a', {
          'configurable': false
        });
      });
    ...
    test('B4', [
      ...
      throws.range(function() {
        vitals.amend.properties({ 'a': 1 }, 'a', { 'fail': true });
      });
    ...
    test('B5', [
      ...
      throws.type(function() {
        vitals.amend.properties({ 'a': 1 }, { 'a': 'fail' });
      });
    ...
    ], function amendPropertiesTestB7() {

      throws(function() {
        vitals.amend.properties({ 'a': 1 }, { 'x': null }, {
          'configurable': false
        });
      });
    ...
    test('B8', [
      { 'a': 1 }, { 'a': { 'fail': true } }
    ], function amendPropertiesTestB8() {
    ...
    ], function amendPropertiesTestB9() {

      throws(function() {
        vitals.amend.properties({ 'a': 1 }, 'a', {
          'set': function setter(){},
          'writable': true
        });
      });
    ...
    ], function amendPropertiesTestB10() {

      throws(function() {
        vitals.amend.properties({ 'a': 1, 'b': 2, 'c': 3 }, ',b,c', {
          'configurable': false
        });
      });
    ...
    ], function amendPropertiesTestB11() {
