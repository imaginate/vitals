/**
 * -----------------------------------------------------------------------------
 * TEST - VITALS METHOD - AMEND.PROPERTIES.CONFIG
 * -----------------------------------------------------------------------------
  ...
  describe('basic tests', function() {
    ...
    describe(title, function() {
      ...
      it(title, function() {
        ...
        var obj = vitals.amend.props.config(newObj(), props);
      ...
      it(title, function() {
        ...
        var obj = vitals.amend.props.config(newObj(), keys, desc);
        each(newObj(), function(val, key) {
          var desc = getDescriptor(obj, key);
          assert( obj[key] === val );
          assert( key in obj );
      ...
      it(title, function() {
        ...
        var desc = { configurable: false };
        var obj = vitals.amend.props.config(newObj(), 'a,b', desc);
        each(newObj(), function(val, key) {
          var desc = getDescriptor(obj, key);
          assert( obj[key] === val );
          assert( key in obj );
    ...
    describe(title, function() {
      ...
      it(title, function() {
        assert.throws(function() {
          vitals.amend.props.config('fail', 'a,b,c', { configurable: false });
        });
      });
      ...
      it(title, function() {
        assert.throws(function() {
          vitals.amend.props.config({ '5': 1 }, 5, { configurable: false });
        });
      });
      ...
      it(title, function() {
        assert.throws(function() {
          vitals.amend.props.config(newObj(), 'a,b,c');
        });
      });
      ...
      it(title, function() {
        assert.throws(function() {
          vitals.amend.props.config(newObj(), { a: 1 });
        });
      });
      ...
      it(title, function() {
        assert.throws(function() {
          vitals.amend.props.config(newObj(), 'a,d', { configurable: false });
        });
      });
 ...
 */
function callStr() {
  return testCall('amend.props.config', arguments, 5, true);
}
