...
describe('vitals.create.object (section:strict)', function() {
  ...
  describe(title, function() {
    ...
    it(title, function() {
      ...
      var obj = vitals.create.obj(proto1, props, desc);
      var proto2 = getPrototype(obj);
      assert( proto1 === proto2 );
      assert( obj.a === 1 );
      assert( obj.b === 2 );
    ...
    it(title, function() {
      ...
      var desc = freeze({ enumerable: false });
      var obj = vitals.create.obj(proto1, props, 5, desc);
      var proto2 = getPrototype(obj);
      assert( proto1 === proto2 );
      assert( obj.a === 5 );
      assert( obj.b === 5 );
  ...
  describe(title, function() {
    ...
    it(title, function() {
      ...
      var desc = freeze({ enumerable: false });
      var obj = vitals.create.obj(proto1, props, desc, 'number');
      var proto2 = getPrototype(obj);
      assert( proto1 === proto2 );
      assert( obj.a === 1 );
      assert( obj.b === 2 );
  ...
  describe(title, function() {
    ...
    it(title, function() {
      ...
      var desc = freeze({ enumerable: false });
      var obj = vitals.create.obj(proto1, props, desc, setter);
      var proto2 = getPrototype(obj);
      assert( proto1 === proto2 );
      assert( obj.a === 1 );
      assert( obj.b === 2 );
    ...
    it(title, function() {
      ...
      var desc = freeze({ enumerable: false });
      var obj = vitals.create.obj(proto1, props, desc, 'number', setter);
      var proto2 = getPrototype(obj);
      assert( proto1 === proto2 );
      assert( obj.a === 1 );
      assert( obj.b === 2 );
