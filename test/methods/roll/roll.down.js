/**
 * -----------------------------------------------------------------------------
 * VITALS UNIT TESTS: vitals.roll.down
 * -----------------------------------------------------------------------------
 * @section base
...
method('roll.down', function() {

  should('reduce the source object to a result', function() {

    // Note that since iteration order is not guaranteed a _base_ should be used.

    test(0, '<object>', '<iteratee>', function() {
      var obj = { a: 1, b: 2, c: 3 };
      var result = vitals.roll.down(0, obj, function(val) {
        return val;
      });
      assert( result === -6 );
    });
    ...
    test(1, '<object>', '<iteratee>', function() {
      var obj = { a: 1, b: 2, c: 3 };
      var result = vitals.roll.down(1, obj, function(val) {
        return val;
      });
      assert( result === -5 );
    });
  ...
  should('reduce the source array to a result', function() {
    ...
    test('<array>', '<iteratee>', function() {
      var arr = [ 1, 2, 3 ];
      var result = vitals.roll.down(arr, function(val) {
        return val;
      });
      assert( result === -4 );
    });
    ...
    test(0, '<array>', '<iteratee>', function() {
      var arr = [ 1, 2, 3 ];
      var result = vitals.roll.down(0, arr, function(val) {
        return val;
      });
      assert( result === -6 );
    });
    ...
    test(1, '<array>', '<iteratee>', function() {
      var arr = [ 1, 2, 3 ];
      var result = vitals.roll.down(1, arr, function(val) {
        return val;
      });
      assert( result === -5 );
    });
  ...
  should('iterate over all index => value pairs', function() {
    ...
    test('<array>', '<iteratee>', function() {
      ...
      var vals = [];
      var keys = [];
      vitals.roll.down(arr, function(val, i) {
        vals.push(val);
        keys.push(i);
        return 0;
      });
  ...
  should('call the iteratee x times', function() {
    ...
    test(0, 3, '<iteratee>', function() {
      var keys = [];
      vitals.roll.down(0, 3, function(i) {
        keys.push(i);
        return 0;
      });
      assert( keys[0] === 0 );
  ...
  should('correctly clone the source', function() {
    ...
    test('<object>', '<iteratee>', function() {
      var obj = { a: 1, b: 2, c: 3 };
      vitals.roll.down(obj, function(val, key, src) {
        assert( obj !== src );
        return 0;
      });
    });
    ...
    test('<array>', '<iteratee>', function() {
      var arr = [ 1, 2, 3 ];
      vitals.roll.down(arr, function(val, i, src) {
        assert( arr !== src );
        return 0;
      });
    });
