...
(function(u,t){function v(a,b){return"object"===a||!b&&"function"===a}function w(a,b){return(a=a&&b&&a.nodeType?!1:a)&&!b&&a.Object!==Object?!1:!!a}function m(a){a.vitals=t;a.Vitals=t}var x=v(typeof exports)&&w(exports,!0),q=v(typeof module)&&w(module,!0),y=v(typeof global,!0)&&w(global),z=v(typeof window)&&w(window),A=v(typeof self)&&w(self),B=v(typeof u)&&w(u);u=x&&q&&y?global:z&&window!==(u&&u.window)?window:A?self:B?u:Function("return this")();z&&m(window);A&&m(self);m(u);x&&q&&(module.exports===
exports?module.exports=t:m(exports));"function"===typeof define&&define.amd&&"object"===typeof define.amd&&define(function(){return t})})(this,function(u){function t(a){var b;a="vitals."+a;b=function(b,e){e=e||"";e=a+(e&&".")+e;return Error(b+" for "+e+" call.").__vitals=!0};b.type=function(b,e){var c;e=e||"";e=a+(e&&".")+e;c=new TypeError("Invalid "+(b+" param")+" in "+e+" call.");c.__vitals=!0;return c};b.range=function(b,e,c){c=c||"";c=a+(c&&".")+c;b="The "+(b+" param")+" was out-of-range for a "+
c+" call.";e=new RangeError(b+(e?" The valid options are: "+e:""));e.__vitals=!0;return e};return b}function v(a,b,f){for(var e in b)q(b,e)&&(a[e]=b[e]);return a}function w(a,b,f){var e,c;e=a.length;b=b?0>b?e+b:b:0;b=0>b?0:b;f=is.undefined(f)||f>e?e:0>f?e+f:f;if(b>=f)return[];e=Array(f-b);--b;for(c=0;++b<f;)e[c++]=a[b];return e}function m(a){var b;b=x(a,", ")?", ":x(a,",")?",":x(a,"|")?"|":" ";return a.split(b)}var x=function(){var a=String.prototype.includes?function(b,a){return b.includes(a)}:function(a,
f){return-1!==a.indexOf(f)};return function(b,f){f=String(f);return b?f?a(b,f):!0:!f}}(),q=function(){var a=Object.prototype.hasOwnProperty;return function(b,f){return!!b&&a.call(b,f)}}(),y=function(){function a(C,d,k,a,c,r){var n,h;if(!is.obj(C))throw g.type("obj");is.str(d)&&(d=m(d));if(!is.obj(d))throw g.type("props");n=is.arr(d);h=arguments.length;if(n&&3>h)throw g("No val defined");!n&&2<h&&(r=c,c=a,a=k,k=u,++h);if(4===h||5===h)h=b(h,a,c,r),a=h[0],c=h[1],r=h[2];if(!is("!obj=",a))throw g.type("descriptor");
if(!is("str=",c))throw g.type("strongType");if(!is("func=",r))throw g.type("setter");if(c){if(n&&!is(c+"=",k))throw g("The val param is not a valid strongType");if(!n&&!f(c,d))throw g("A props value was not a valid strongType");}return e(C,d,k,a,c,r)}function b(C,d,k,a){switch(C){case 4:is.str(d)?(k=d,d=u):is.func(d)&&(a=d,d=u);break;case 5:is.func(k)&&(a=k,k=u,is.str(d)&&(k=d,d=u))}return[d,k,a]}function f(a,d){var k,c;a+="=";for(k in d)if(q(d,k)){c=d[k];if(is.obj(c)&&x(c)){if(q(c,"writable"))continue;
c=c.value}if(!is(a,c))return!1}return!0}function e(a,d,k,b,e,r){b=y(b||null,!!e||!!r);e=z(e);if(is.arr(d))if(e||r){var n=d,h=b,g;b={};d=n.length;for(g=-1;++g<d;)b[n[g]]=F(k,h,e,r);r=b}else r=c(d,k,b);else if(e||r){h=d;k=b;b={};for(n in h)if(q(h,n)){d=b;g=n;var f;a:{f=h[n];var l=e,u=r,p=void 0,p=v({},k);if(x(f)){p=v(p,f);if(q(p,"writable")||D(p)){f=p;break a}f=p.value;var t=void 0,m=void 0,t={};for(m in p)q(p,m)&&"value"!==m&&(t[m]=p[m]);p=t}f=p=w(f,p,l,u)}d[g]=f}r=b}else{r=d;n=b;k={};for(h in r)q(r,
h)&&(e=k,b=h,d=r[h],g=void 0,g=v({},n),d=x(d)?d:{value:d},d=v(g,d),e[b]=d);r=k}return E(a,r)}function c(a,d,k){var c,b,e,g;c=D(k)?function(d,k){return v({},k)}:p;b={};e=a.length;for(g=-1;++g<e;)b[a[g]]=c(d,k);return b}function l(a,d){var k,c,b;k={};c=a.length;for(b=-1;++b<c;)k[a[b]]=d;return k}function p(a,d){var k;k=v({},d);k.value=a;return k}function F(a,d,k,b){d=v({},d);return d=w(a,d,k,b)}function w(a,d,k,b){var c;d.get=function(){return a};d.set=k&&b?function(d){if(!k(d))throw c=new TypeError("Invalid type for object property value."),
c.__setter=!0,c.__type=!0,c;a=b(d,a)}:k?function(d){if(!k(d))throw c=new TypeError("Invalid type for object property value."),c.__setter=!0,c.__type=!0,c;a=d}:function(d){a=b(d,a)};return d}function x(a){var d;if(!is.obj(a))return!1;for(d in a)if(q(a,d)&&!q(I,d))return!1;return!0}function D(a){return q(a,"get")||q(a,"set")}function y(a,d){var c;if(c=d)c=a,c=q(c,"value")||q(c,"writable");c&&(c={},is.bool(a.enumerable)&&(c.enumerable=a.enumerable),is.bool(a.configurable)&&(c.configurable=a.configurable),
a=c);c=d||D(a)?J:B;c=v({},c);return v(c,a)}function z(a){return a&&function(d){return is(a,d)}}function A(a,d){for(var c in d)if(q(d,c)&&!q(a,c))return!1;return!0}a.config=function(a,d,c){if(!is.obj(a))throw g.type("obj","config");is.str(d)&&(d=m(d));if(!is.obj(d))throw g.type("props","config");if(is.arr(d)){if(!is.obj(c))throw g.type("descriptor","config");d=l(d,c)}if(!A(a,d))throw g("A given prop was not defined in the obj","config");return E(a,d)};a.property=function(a,d,c,b,e,f){var n;if(!is.obj(a))throw g.type("obj",
"property");if(!is.str(d))throw g.type("key","property");n=arguments.length;if(3>n)throw g("No val or descriptor defined","property");if(2<n&&6>n){var h=c,l=b,m=e,t=f;switch(n){case 4:is.str(l)?(m=l,l=u):is.func(l)&&(t=l,l=u);break;case 5:is.func(m)&&(t=m,m=u,is.str(l)&&(m=l,l=u))}is.obj(h)&&x(h)&&(l=h,h=l.value);n=[h,l,m,t];c=n[0];b=n[1];e=n[2];f=n[3]}if(!is("!obj=",b))throw g.type("descriptor","property");if(!is("str=",e))throw g.type("strongType","property");if(!is("func=",f))throw g.type("setter",
"property");if(e&&!is(e+"=",c))throw g("The val param is not a valid strongType","property");if(b&&(e||f)&&q(b,"writable"))throw g("A data descriptor may not be used with a strongType/setter","property");n=c;l=e;m=f;h=b||null;h=y(h,!!l||!!m);h=(l=z(l))||m?F(n,h,l,m):D(h)?v({},h):p(n,h);return G(a,d,h)};a.prop=a.property;a.property.config=function(a,d,c){if(!is.obj(a))throw g.type("obj","property.config");if(!is.str(d))throw g.type("key","property.config");if(!is.obj(c))throw g.type("descriptor","property.config");
if(!q(a,d))throw g("The key was not defined in the obj","property.config");return G(a,d,c)};a.prop.config=a.property.config;a.properties=function(a,d,c,l,p,r){var n,h;if(!is.obj(a))throw g.type("obj","properties");is.str(d)&&(d=m(d));if(!is.obj(d))throw g.type("props","properties");n=is.arr(d);h=arguments.length;if(n&&3>h)throw g("No val defined","properties");!n&&2<h&&(r=p,p=l,l=c,c=u,++h);if(4===h||5===h)h=b(h,l,p,r),l=h[0],p=h[1],r=h[2];if(!is("!obj=",l))throw g.type("descriptor","properties");
if(!is("str=",p))throw g.type("strongType","properties");if(!is("func=",r))throw g.type("setter","properties");if(p){if(n&&!is(p+"=",c))throw g("The val param is not a valid strongType","properties");if(!n&&!f(p,d))throw g("A props value was not a valid strongType","properties");}return e(a,d,c,l,p,r)};a.props=a.properties;a.properties.config=function(a,c,b){if(!is.obj(a))throw g.type("obj","properties.config");is.str(c)&&(c=m(c));if(!is.obj(c))throw g.type("props","properties.config");if(is.arr(c)){if(!is.obj(b))throw g.type("descriptor",
"properties.config");c=l(c,b)}if(!A(a,c))throw g("A given prop was not defined in the obj","properties.config");return E(a,c)};a.props.config=a.properties.config;var B={writable:!0,enumerable:!0,configurable:!0},J={enumerable:!0,configurable:!0},I={get:!0,set:!0,value:!0,writable:!0,enumerable:!0,configurable:!0},H=!!Object.defineProperties&&function(){var a,c,b;c={};a={enumerable:!1,value:c};try{for(b in Object.defineProperty(c,"prop",a),c)if("prop"===b)return!1}catch(e){return!1}return c.prop===
c}(),G=H?Object.defineProperty:function(c,a,b){c[a]=q(b,"get")?b.get():b.value;return c},E=H?Object.defineProperties:function(c,a){var b,e;for(e in a)q(a,e)&&(b=a[e],c[e]=q(b,"get")?b.get():b.value);return c},g=t("amend");return a}(),z=function(){function a(c,a,b,m,q,u){var t;if(!is("?obj",c))throw e.type("proto");return 1<arguments.length?(t=w(arguments),t[0]=f(c),y.apply(null,t)):f(c)}function b(){}a.object=function(c,a,b,m,q,u){var t;if(!is("?obj",c))throw e.type("proto","object");return 1<arguments.length?
(t=w(arguments),t[0]=f(c),y.apply(null,t)):f(c)};a.obj=a.object;var f=Object.create||function(a){b.prototype=a;a=new b;b.prototype=null;return a},e=t("create");return a}(),A=function(){function a(a,l){if(is.nil(a))return null;if(!is._obj(a))throw e.type("obj");if(!is("bool=",l))throw e.type("deep");return l?b(a):f(a)}function b(a,e){var p,m;p=is.frozen(a);for(m in a)q(a,m)&&is._obj(a[m])&&(a[m]=b(a[m],p));return e?a:f(a)}a.object=function(a,l){if(is.nil(a))return null;if(!is._obj(a))throw e.type("obj",
"object");if(!is("bool=",l))throw e.type("deep","object");return l?b(a):f(a)};a.obj=a.object;var f=function(){if(!Object.freeze)return function(a){return a};try{Object.freeze(function(){})}catch(a){return function(a){return is.func(a)?a:Object.freeze(a)}}return Object.freeze}(),e=t("freeze");return a}(),B=function(){function a(a,l){if(is.nil(a))return null;if(!is._obj(a))throw e.type("obj");if(!is("bool=",l))throw e.type("deep");return l?f(a):b(a)}a.object=function(a,l){if(is.nil(a))return null;if(!is._obj(a))throw e.type("obj",
"seal");if(!is("bool=",l))throw e.type("deep","seal");return l?f(a):b(a)};a.obj=a.object;var b=Object.seal?Object.seal:function(a){return a},f=Object.seal?function l(a){var e,f;for(e in a)q(a,e)&&(f=a[e],is._obj(f)&&(a[e]=l(f)));return b(a)}:function(a){return a},e=t("seal");return a}();return{amend:y,create:z,freeze:A,seal:B}}());
