...
Object.defineProperty:function(a,b,c){a[b]=m(c,"get")?c.get():c.value;return a},L=E?Object.defineProperties:function(a,b){var c,d;for(d in b)m(b,d)&&(c=b[d],a[d]=m(c,"get")?c.get():c.value);return a},l=n("amend");return d}(),D=function(){function d(a,c,d,h,m,n){var g;if(!b.nil.obj(a))throw e.type("proto");return 1<arguments.length?(g=x(arguments),g[0]=f(a),z.apply(null,g)):f(a)}function c(){}d.object=function(a,c,d,h,m,n){var g;if(!b.nil.obj(a))throw e.type("proto","object");return 1<arguments.length?
(g=x(arguments),g[0]=f(a),z.apply(null,g)):f(a)};d.obj=d.object;var f=Object.create||function(a){c.prototype=a;a=new c;c.prototype=null;return a},e=n("create");return d}(),I=function(){function d(a,d){if(b.nil(a))return null;if(!b._obj(a))throw e.type("obj");if(!b.un.bool(d))throw e.type("deep");return d?c(a):f(a)}function c(a,d){for(var e in a)m(a,e)&&b._obj(a[e])&&c(a[e]);return f(a)}d.object=function(a,d){if(b.nil(a))return null;if(!b._obj(a))throw e.type("obj","object");if(!b.un.bool(d))throw e.type("deep",
"object");return d?c(a):f(a)};d.obj=d.object;var f=function(){if(!Object.freeze)return function(a){return a};try{return Object.freeze(function(){}),Object.freeze}catch(a){return function(a){return b.func(a)?a:Object.freeze(a)}}}(),e=n("freeze");return d}(),J=function(){function d(a,d){if(b.nil(a))return null;if(!b._obj(a))throw e.type("obj");if(!b.un.bool(d))throw e.type("deep");return d?f(a):c(a)}d.object=function(a,d){if(b.nil(a))return null;if(!b._obj(a))throw e.type("obj","seal");if(!b.un.bool(d))throw e.type("deep",
"seal");return d?f(a):c(a)};d.obj=d.object;var c=Object.seal?Object.seal:function(a){return a},f=Object.seal?function p(d){for(var e in d)m(d,e)&&b._obj(d[e])&&p(d[e]);return c(d)}:function(b){return b},e=n("seal");return d}();return{amend:z,create:D,freeze:I,seal:J}}());
