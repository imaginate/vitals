...
/* vitals-strict.js v2.3.1 (https://github.com/imaginate/vitals)
 * Copyright (c) 2015 Adam A Smith <adam@imaginate.life>
 * The Apache License (https://github.com/imaginate/vitals/blob/master/LICENSE.md) */
(function(u,t){function v(a,b){return"object"===a||!b&&"function"===a}function w(a,b){return(a=a&&b&&a.nodeType?!1:a)&&!b&&a.Object!==Object?!1:!!a}function n(a){a.vitals=t;a.Vitals=t}var x=v(typeof exports)&&w(exports,!0),q=v(typeof module)&&w(module,!0),y=v(typeof global,!0)&&w(global),z=v(typeof window)&&w(window),A=v(typeof self)&&w(self),B=v(typeof u)&&w(u);u=x&&q&&y?global:z&&window!==(u&&u.window)?window:A?self:B?u:Function("return this")();z&&n(window);A&&n(self);n(u);x&&q&&(module.exports===
exports?module.exports=t:n(exports));"function"===typeof define&&define.amd&&"object"===typeof define.amd&&define(function(){return t})})(this,function(u){function t(a){var b;a="vitals."+a;b=function(b,d){d=d||"";d=a+(d&&".")+d;return Error(b+" for "+d+" call.").__vitals=!0};b.type=function(b,d){var e;d=d||"";d=a+(d&&".")+d;e=new TypeError("Invalid "+(b+" param")+" in "+d+" call.");e.__vitals=!0;return e};b.range=function(b,d,e){e=e||"";e=a+(e&&".")+e;b="The "+(b+" param")+" was out-of-range for a "+
e+" call.";d=new RangeError(b+(d?" The valid options are: "+d:""));d.__vitals=!0;return d};return b}function v(a,b,f){for(var d in b)q(b,d)&&(a[d]=b[d]);return a}function w(a,b,f){var d,e;d=a.length;b=b?0>b?d+b:b:0;b=0>b?0:b;f=is.undefined(f)||f>d?d:0>f?d+f:f;if(b>=f)return[];d=Array(f-b);--b;for(e=0;++b<f;)d[e++]=a[b];return d}function n(a){var b;b=x(a,", ")?", ":x(a,",")?",":x(a,"|")?"|":" ";return a.split(b)}var x=function(){var a=String.prototype.includes?function(b,a){return b.includes(a)}:function(a,
f){return-1!==a.indexOf(f)};return function(b,f){f=String(f);return b?f?a(b,f):!0:!f}}(),q=function(){var a=Object.prototype.hasOwnProperty;return function(b,f){return!!b&&a.call(b,f)}}(),y=function(){function a(C,c,k,a,e,r){var m,h;if(!is.obj(C))throw g.type("obj");is.str(c)&&(c=n(c));if(!is.obj(c))throw g.type("props");m=is.arr(c);h=arguments.length;if(m&&3>h)throw g("No val defined");!m&&2<h&&(r=e,e=a,a=k,k=u,++h);if(4===h||5===h)h=b(h,a,e,r),a=h[0],e=h[1],r=h[2];if(!is("!obj=",a))throw g.type("descriptor");
if(!is("str=",e))throw g.type("strongType");if(!is("func=",r))throw g.type("setter");if(e){if(m&&!is(e+"=",k))throw g("The val param is not a valid strongType");if(!m&&!f(e,c))throw g("A props value was not a valid strongType");}return d(C,c,k,a,e,r)}function b(C,c,k,a){switch(C){case 4:is.str(c)?(k=c,c=u):is.func(c)&&(a=c,c=u);break;case 5:is.func(k)&&(a=k,k=u,is.str(c)&&(k=c,c=u))}return[c,k,a]}function f(a,c){var k,e;a+="=";for(k in c)if(q(c,k)){e=c[k];if(is.obj(e)&&x(e)){if(q(e,"writable"))continue;
e=e.value}if(!is(a,e))return!1}return!0}function d(a,c,k,b,d,r){b=y(b||null,!!d||!!r);d=z(d);if(is.arr(c))if(d||r){var m=c,h=b,g;b={};c=m.length;for(g=-1;++g<c;)b[m[g]]=F(k,h,d,r);r=b}else r=e(c,k,b);else if(d||r){h=c;k=b;b={};for(m in h)if(q(h,m)){c=b;g=m;var f;a:{f=h[m];var l=d,u=r,p=void 0,p=v({},k);if(x(f)){p=v(p,f);if(q(p,"writable")||D(p)){f=p;break a}f=p.value;var t=void 0,n=void 0,t={};for(n in p)q(p,n)&&"value"!==n&&(t[n]=p[n]);p=t}f=p=w(f,p,l,u)}c[g]=f}r=b}else{r=c;m=b;k={};for(h in r)q(r,
h)&&(d=k,b=h,c=r[h],g=void 0,g=v({},m),c=x(c)?c:{value:c},c=v(g,c),d[b]=c);r=k}return E(a,r)}function e(a,c,k){var e,b,d,g;e=D(k)?function(c,k){return v({},k)}:p;b={};d=a.length;for(g=-1;++g<d;)b[a[g]]=e(c,k);return b}function l(a,c){var k,b,e;k={};b=a.length;for(e=-1;++e<b;)k[a[e]]=c;return k}function p(a,c){var k;k=v({},c);k.value=a;return k}function F(a,c,k,e){c=v({},c);return c=w(a,c,k,e)}function w(a,c,k,e){var b;c.get=function(){return a};c.set=k&&e?function(c){if(!k(c))throw b=new TypeError("Invalid type for object property value."),
b.__setter=!0,b.__type=!0,b;a=e(c,a)}:k?function(c){if(!k(c))throw b=new TypeError("Invalid type for object property value."),b.__setter=!0,b.__type=!0,b;a=c}:function(c){a=e(c,a)};return c}function x(a){var c;if(!is.obj(a))return!1;for(c in a)if(q(a,c)&&!q(I,c))return!1;return!0}function D(a){return q(a,"get")||q(a,"set")}function y(a,c){var b;if(b=c)b=a,b=q(b,"value")||q(b,"writable");b&&(b={},is.bool(a.enumerable)&&(b.enumerable=a.enumerable),is.bool(a.configurable)&&(b.configurable=a.configurable),
a=b);b=c||D(a)?J:B;b=v({},b);return v(b,a)}function z(a){return a&&function(c){return is(a,c)}}function A(a,c){for(var b in c)if(q(c,b)&&!q(a,b))return!1;return!0}a.config=function(a,c,b){if(!is.obj(a))throw g.type("obj","config");is.str(c)&&(c=n(c));if(!is.obj(c))throw g.type("props","config");if(is.arr(c)){if(!is.obj(b))throw g.type("descriptor","config");c=l(c,b)}if(!A(a,c))throw g("A given prop was not defined in the obj","config");return E(a,c)};a.property=function(a,c,b,e,d,f){var m;if(!is.obj(a))throw g.type("obj",
"property");if(!is.str(c))throw g.type("key","property");m=arguments.length;if(3>m)throw g("No val or descriptor defined","property");if(2<m&&6>m){var h=b,l=e,n=d,t=f;switch(m){case 4:is.str(l)?(n=l,l=u):is.func(l)&&(t=l,l=u);break;case 5:is.func(n)&&(t=n,n=u,is.str(l)&&(n=l,l=u))}is.obj(h)&&x(h)&&(l=h,h=l.value);m=[h,l,n,t];b=m[0];e=m[1];d=m[2];f=m[3]}if(!is("!obj=",e))throw g.type("descriptor","property");if(!is("str=",d))throw g.type("strongType","property");if(!is("func=",f))throw g.type("setter",
"property");if(d&&!is(d+"=",b))throw g("The val param is not a valid strongType","property");if(e&&(d||f)&&q(e,"writable"))throw g("A data descriptor may not be used with a strongType/setter","property");m=b;l=d;n=f;h=e||null;h=y(h,!!l||!!n);h=(l=z(l))||n?F(m,h,l,n):D(h)?v({},h):p(m,h);return G(a,c,h)};a.prop=a.property;a.property.config=function(a,c,b){if(!is.obj(a))throw g.type("obj","property.config");if(!is.str(c))throw g.type("key","property.config");if(!is.obj(b))throw g.type("descriptor","property.config");
if(!q(a,c))throw g("The key was not defined in the obj","property.config");return G(a,c,b)};a.prop.config=a.property.config;a.properties=function(a,c,e,l,p,r){var m,h;if(!is.obj(a))throw g.type("obj","properties");is.str(c)&&(c=n(c));if(!is.obj(c))throw g.type("props","properties");m=is.arr(c);h=arguments.length;if(m&&3>h)throw g("No val defined","properties");!m&&2<h&&(r=p,p=l,l=e,e=u,++h);if(4===h||5===h)h=b(h,l,p,r),l=h[0],p=h[1],r=h[2];if(!is("!obj=",l))throw g.type("descriptor","properties");
if(!is("str=",p))throw g.type("strongType","properties");if(!is("func=",r))throw g.type("setter","properties");if(p){if(m&&!is(p+"=",e))throw g("The val param is not a valid strongType","properties");if(!m&&!f(p,c))throw g("A props value was not a valid strongType","properties");}return d(a,c,e,l,p,r)};a.props=a.properties;a.properties.config=function(a,c,b){if(!is.obj(a))throw g.type("obj","properties.config");is.str(c)&&(c=n(c));if(!is.obj(c))throw g.type("props","properties.config");if(is.arr(c)){if(!is.obj(b))throw g.type("descriptor",
"properties.config");c=l(c,b)}if(!A(a,c))throw g("A given prop was not defined in the obj","properties.config");return E(a,c)};a.props.config=a.properties.config;var B={writable:!0,enumerable:!0,configurable:!0},J={enumerable:!0,configurable:!0},I={get:!0,set:!0,value:!0,writable:!0,enumerable:!0,configurable:!0},H=!!Object.defineProperties&&function(){var a,b,e;b={};a={enumerable:!1,value:b};try{for(e in Object.defineProperty(b,"prop",a),b)if("prop"===e)return!1}catch(d){return!1}return b.prop===
b}(),G=H?Object.defineProperty:function(a,b,e){a[b]=q(e,"get")?e.get():e.value;return a},E=H?Object.defineProperties:function(a,b){var e,d;for(d in b)q(b,d)&&(e=b[d],a[d]=q(e,"get")?e.get():e.value);return a},g=t("amend");return a}(),z=function(){function a(a,b,p,n,q,u){var t;if(!is("?obj",a))throw d.type("proto");return 1<arguments.length?(t=w(arguments),t[0]=f(a),y.apply(null,t)):f(a)}function b(){}a.object=function(a,b,p,n,q,u){var t;if(!is("?obj",a))throw d.type("proto","object");return 1<arguments.length?
(t=w(arguments),t[0]=f(a),y.apply(null,t)):f(a)};a.obj=a.object;var f=Object.create||function(a){b.prototype=a;a=new b;b.prototype=null;return a},d=t("create");return a}(),A=function(){function a(a,l){if(is.nil(a))return null;if(!is._obj(a))throw d.type("obj");if(!is("bool=",l))throw d.type("deep");return l?b(a):f(a)}function b(a,d){var p,n;p=is.frozen(a);for(n in a)q(a,n)&&is._obj(a[n])&&b(a[n],p);return d?a:f(a)}a.object=function(a,l){if(is.nil(a))return null;if(!is._obj(a))throw d.type("obj","object");
if(!is("bool=",l))throw d.type("deep","object");return l?b(a):f(a)};a.obj=a.object;var f=function(){if(!Object.freeze)return function(a){return a};try{Object.freeze(function(){})}catch(a){return function(a){return is.func(a)?a:Object.freeze(a)}}return Object.freeze}(),d=t("freeze");return a}(),B=function(){function a(a,l){if(is.nil(a))return null;if(!is._obj(a))throw d.type("obj");if(!is("bool=",l))throw d.type("deep");return l?f(a):b(a)}a.object=function(a,l){if(is.nil(a))return null;if(!is._obj(a))throw d.type("obj",
"seal");if(!is("bool=",l))throw d.type("deep","seal");return l?f(a):b(a)};a.obj=a.object;var b=Object.seal?Object.seal:function(a){return a},f=Object.seal?function l(a){var d,f;for(d in a)q(a,d)&&(f=a[d],is._obj(f)&&(a[d]=l(f)));return b(a)}:function(a){return a},d=t("seal");return a}();return{amend:y,create:z,freeze:A,seal:B}}());
