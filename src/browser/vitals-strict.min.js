...
/* vitals-strict.js v2.2.1 (https://github.com/imaginate/vitals)
 * Copyright (c) 2015 Adam A Smith <adam@imaginate.life>
 * The Apache License (https://github.com/imaginate/vitals/blob/master/LICENSE.md) */
(function(q,m){function t(a,c){return"object"===a||!c&&"function"===a}function w(a,c){return(a=a&&c&&a.nodeType?!1:a)&&!c&&a.Object!==Object?!1:!!a}function r(a){a.vitals=m;a.Vitals=m}var x=t(typeof exports)&&w(exports,!0),n=t(typeof module)&&w(module,!0),y=t(typeof global,!0)&&w(global),z=t(typeof window)&&w(window),A=t(typeof self)&&w(self),C=t(typeof q)&&w(q);q=x&&n&&y?global:z&&window!==(q&&q.window)?window:A?self:C?q:Function("return this")();z&&r(window);A&&r(self);r(q);x&&n&&(module.exports===
exports?module.exports=m:r(exports));"function"===typeof define&&define.amd&&"object"===typeof define.amd&&define(function(){return m})})(this,function(q){function m(a){var c;a="vitals."+a;c=function(c,d){d=d||"";d=a+(d&&".")+d;return Error(c+" for "+d+" call.")};c.type=function(c,d){d=d||"";d=a+(d&&".")+d;return new TypeError("Invalid "+(c+" param")+" in "+d+" call.")};c.range=function(c,d,e){e=e||"";e=a+(e&&".")+e;c="The "+(c+" param")+" was out-of-range for a "+e+" call.";return new RangeError(c+
(d?" The valid options are: "+d:""))};return c}function t(a,c,g){for(var d in c)n(c,d)&&(a[d]=c[d]);return a}function w(a,c,g){var d,e;d=a.length;c=c?0>c?d+c:c:0;c=0>c?0:c;g=is.undefined(g)||g>d?d:0>g?d+g:g;if(c>=g)return[];d=Array(g-c);--c;for(e=0;++c<g;)d[e++]=a[c];return d}function r(a){var c;c=x(a,", ")?", ":x(a,",")?",":x(a,"|")?"|":" ";return a.split(c)}var x=function(){var a=String.prototype.includes?function(c,a){return c.includes(a)}:function(a,g){return-1!==a.indexOf(g)};return function(c,
g){g=String(g);return c?g?a(c,g):!0:!g}}(),n=function(){var a=Object.prototype.hasOwnProperty;return function(c,g){return!!c&&a.call(c,g)}}(),y=function(){function a(D,b,f,a,e,p){var u,k;if(!is.obj(D))throw h.type("obj");is.str(b)&&(b=r(b));if(!is.obj(b))throw h.type("props");u=is.arr(b);k=arguments.length;if(u&&3>k)throw h("No val defined");!u&&2<k&&(p=e,e=a,a=f,f=q,++k);if(4===k||5===k)k=c(k,a,e,p),a=k[0],e=k[1],p=k[2];if(!is("!obj=",a))throw h.type("descriptor");if(!is("str=",e))throw h.type("strongType");
if(!is("func=",p))throw h.type("setter");if(e){if(u&&!is(e+"=",f))throw h("The val param is not a valid strongType");if(!u&&!g(e,b))throw h("A props value was not a valid strongType");}return d(D,b,f,a,e,p)}function c(D,b,f,a){switch(D){case 4:is.str(b)?(f=b,b=q):is.func(b)&&(a=b,b=q);break;case 5:is.func(f)&&(a=f,f=q,is.str(b)&&(f=b,b=q))}return[b,f,a]}function g(a,b){var f,e;a+="=";for(f in b)if(n(b,f)){e=b[f];if(is.obj(e)&&x(e)){if(n(e,"writable"))continue;e=e.value}if(!is(a,e))return!1}return!0}
function d(a,b,f,c,d,p){c=y(c||null,!!d||!!p);d=z(d);if(is.arr(b))if(d||p){var u=b,k=c,h;c={};b=u.length;for(h=-1;++h<b;)c[u[h]]=w(f,k,d,p);p=c}else p=e(b,f,c);else if(d||p){k=b;f=c;c={};for(u in k)if(n(k,u)){b=c;h=u;var g;a:{g=k[u];var l=d,q=p,v=void 0,v=t({},f);if(x(g)){v=t(v,g);if(n(v,"writable")||E(v)){g=v;break a}g=v.value;var B=void 0,m=void 0,B={};for(m in v)n(v,m)&&"value"!==m&&(B[m]=v[m]);v=B}g=v=G(g,v,l,q)}b[h]=g}p=c}else{p=b;u=c;f={};for(k in p)n(p,k)&&(d=f,c=k,b=p[k],h=void 0,h=t({},u),
b=x(b)?b:{value:b},b=t(h,b),d[c]=b);p=f}return F(a,p)}function e(a,b,f){var c,e,d,h;c=E(f)?function(b,f){return t({},f)}:B;e={};d=a.length;for(h=-1;++h<d;)e[a[h]]=c(b,f);return e}function l(a,b){var f,c,e;f={};c=a.length;for(e=-1;++e<c;)f[a[e]]=b;return f}function B(a,b){var f;f=t({},b);f.value=a;return f}function w(a,b,f,c){b=t({},b);return b=G(a,b,f,c)}function G(a,b,f,c){var e;b.get=function(){return a};b.set=f&&c?function(b){if(!f(b))throw e=new TypeError("Invalid type for object property value."),
e.__setter=!0,e.__type=!0,e;a=c(b,a)}:f?function(b){if(!f(b))throw e=new TypeError("Invalid type for object property value."),e.__setter=!0,e.__type=!0,e;a=b}:function(b){a=c(b,a)};return b}function x(a){var b;if(!is.obj(a))return!1;for(b in a)if(n(a,b)&&!n(J,b))return!1;return!0}function E(a){return n(a,"get")||n(a,"set")}function y(a,b){var f;if(f=b)f=a,f=n(f,"value")||n(f,"writable");f&&(f={},is.bool(a.enumerable)&&(f.enumerable=a.enumerable),is.bool(a.configurable)&&(f.configurable=a.configurable),
a=f);f=b||E(a)?K:C;f=t({},f);return t(f,a)}function z(a){return a&&function(b){return is(a,b)}}function A(a,b){for(var f in b)if(n(b,f)&&!n(a,f))return!1;return!0}a.config=function(a,b,f){if(!is.obj(a))throw h.type("obj","config");is.str(b)&&(b=r(b));if(!is.obj(b))throw h.type("props","config");if(is.arr(b)){if(!is.obj(f))throw h.type("descriptor","config");b=l(b,f)}if(!A(a,b))throw h("A given prop was not defined in the obj","config");return F(a,b)};a.property=function(a,b,f,e,c,d){var g;if(!is.obj(a))throw h.type("obj",
"property");if(!is.str(b))throw h.type("key","property");g=arguments.length;if(3>g)throw h("No val or descriptor defined","property");if(2<g&&6>g){var k=f,l=e,m=c,r=d;switch(g){case 4:is.str(l)?(m=l,l=q):is.func(l)&&(r=l,l=q);break;case 5:is.func(m)&&(r=m,m=q,is.str(l)&&(m=l,l=q))}is.obj(k)&&x(k)&&(l=k,k=l.value);g=[k,l,m,r];f=g[0];e=g[1];c=g[2];d=g[3]}if(!is("!obj=",e))throw h.type("descriptor","property");if(!is("str=",c))throw h.type("strongType","property");if(!is("func=",d))throw h.type("setter",
"property");if(c&&!is(c+"=",f))throw h("The val param is not a valid strongType","property");if(e&&(c||d)&&n(e,"writable"))throw h("A data descriptor may not be used with a strongType/setter","property");g=f;l=c;m=d;k=e||null;k=y(k,!!l||!!m);k=(l=z(l))||m?w(g,k,l,m):E(k)?t({},k):B(g,k);return H(a,b,k)};a.prop=a.property;a.property.config=function(a,b,c){if(!is.obj(a))throw h.type("obj","property.config");if(!is.str(b))throw h.type("key","property.config");if(!is.obj(c))throw h.type("descriptor","property.config");
if(!n(a,b))throw h("The key was not defined in the obj","property.config");return H(a,b,c)};a.prop.config=a.property.config;a.properties=function(a,b,e,l,m,p){var n,k;if(!is.obj(a))throw h.type("obj","properties");is.str(b)&&(b=r(b));if(!is.obj(b))throw h.type("props","properties");n=is.arr(b);k=arguments.length;if(n&&3>k)throw h("No val defined","properties");!n&&2<k&&(p=m,m=l,l=e,e=q,++k);if(4===k||5===k)k=c(k,l,m,p),l=k[0],m=k[1],p=k[2];if(!is("!obj=",l))throw h.type("descriptor","properties");
if(!is("str=",m))throw h.type("strongType","properties");if(!is("func=",p))throw h.type("setter","properties");if(m){if(n&&!is(m+"=",e))throw h("The val param is not a valid strongType","properties");if(!n&&!g(m,b))throw h("A props value was not a valid strongType","properties");}return d(a,b,e,l,m,p)};a.props=a.properties;a.properties.config=function(a,b,e){if(!is.obj(a))throw h.type("obj","properties.config");is.str(b)&&(b=r(b));if(!is.obj(b))throw h.type("props","properties.config");if(is.arr(b)){if(!is.obj(e))throw h.type("descriptor",
"properties.config");b=l(b,e)}if(!A(a,b))throw h("A given prop was not defined in the obj","properties.config");return F(a,b)};a.props.config=a.properties.config;var C={writable:!0,enumerable:!0,configurable:!0},K={enumerable:!0,configurable:!0},J={get:!0,set:!0,value:!0,writable:!0,enumerable:!0,configurable:!0},I=!!Object.defineProperties&&function(){var a,b,e;b={};a={enumerable:!1,value:b};try{for(e in Object.defineProperty(b,"prop",a),b)if("prop"===e)return!1}catch(c){return!1}return b.prop===
b}(),H=I?Object.defineProperty:function(a,b,e){a[b]=n(e,"get")?e.get():e.value;return a},F=I?Object.defineProperties:function(a,b){var e,c;for(c in b)n(b,c)&&(e=b[c],a[c]=n(e,"get")?e.get():e.value);return a},h=m("amend");return a}(),z=function(){function a(a,c,m,n,q,t){var r;if(!is("?obj",a))throw d.type("proto");return 1<arguments.length?(r=w(arguments),r[0]=g(a),y.apply(null,r)):g(a)}function c(){}a.object=function(a,c,m,n,q,t){var r;if(!is("?obj",a))throw d.type("proto","object");return 1<arguments.length?
(r=w(arguments),r[0]=g(a),y.apply(null,r)):g(a)};a.obj=a.object;var g=Object.create||function(a){c.prototype=a;a=new c;c.prototype=null;return a},d=m("create");return a}(),A=function(){function a(a,l){if(is.nil(a))return null;if(!is._obj(a))throw d.type("obj");if(!is("bool=",l))throw d.type("deep");return l?c(a):g(a)}function c(a){for(var d in a)n(a,d)&&is._obj(a[d])&&(a[d]=c(a[d]));return g(a)}a.object=function(a,l){if(is.nil(a))return null;if(!is._obj(a))throw d.type("obj","object");if(!is("bool=",
l))throw d.type("deep","object");return l?c(a):g(a)};a.obj=a.object;var g=function(){if(!Object.freeze)return function(a){return a};try{Object.freeze(function(){})}catch(a){return function(a){return is.func(a)?a:Object.freeze(a)}}return Object.freeze}(),d=m("freeze");return a}(),C=function(){function a(a,l){if(is.nil(a))return null;if(!is._obj(a))throw d.type("obj");if(!is("bool=",l))throw d.type("deep");return l?g(a):c(a)}a.object=function(a,l){if(is.nil(a))return null;if(!is._obj(a))throw d.type("obj",
"seal");if(!is("bool=",l))throw d.type("deep","seal");return l?g(a):c(a)};a.obj=a.object;var c=Object.seal?Object.seal:function(a){return a},g=Object.seal?function l(a){var d,g;for(d in a)n(a,d)&&(g=a[d],is._obj(g)&&(a[d]=l(g)));return c(a)}:function(a){return a},d=m("seal");return a}();return{amend:y,create:z,freeze:A,seal:C}}());
