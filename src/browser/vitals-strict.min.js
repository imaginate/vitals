...
/* vitals-strict.js v2.3.0 (https://github.com/imaginate/vitals)
 * Copyright (c) 2015 Adam A Smith <adam@imaginate.life>
 * The Apache License (https://github.com/imaginate/vitals/blob/master/LICENSE.md) */
(function(r,m){function t(a,b){return"object"===a||!b&&"function"===a}function w(a,b){return(a=a&&b&&a.nodeType?!1:a)&&!b&&a.Object!==Object?!1:!!a}function u(a){a.vitals=m;a.Vitals=m}var x=t(typeof exports)&&w(exports,!0),p=t(typeof module)&&w(module,!0),y=t(typeof global,!0)&&w(global),z=t(typeof window)&&w(window),A=t(typeof self)&&w(self),C=t(typeof r)&&w(r);r=x&&p&&y?global:z&&window!==(r&&r.window)?window:A?self:C?r:Function("return this")();z&&u(window);A&&u(self);u(r);x&&p&&(module.exports===
exports?module.exports=m:u(exports));"function"===typeof define&&define.amd&&"object"===typeof define.amd&&define(function(){return m})})(this,function(r){function m(a){var b;a="vitals."+a;b=function(b,e){e=e||"";e=a+(e&&".")+e;return Error(b+" for "+e+" call.").__vitals=!0};b.type=function(b,e){var c;e=e||"";e=a+(e&&".")+e;c=new TypeError("Invalid "+(b+" param")+" in "+e+" call.");c.__vitals=!0;return c};b.range=function(b,e,c){c=c||"";c=a+(c&&".")+c;b="The "+(b+" param")+" was out-of-range for a "+
c+" call.";e=new RangeError(b+(e?" The valid options are: "+e:""));e.__vitals=!0;return e};return b}function t(a,b,f){for(var e in b)p(b,e)&&(a[e]=b[e]);return a}function w(a,b,f){var e,c;e=a.length;b=b?0>b?e+b:b:0;b=0>b?0:b;f=is.undefined(f)||f>e?e:0>f?e+f:f;if(b>=f)return[];e=Array(f-b);--b;for(c=0;++b<f;)e[c++]=a[b];return e}function u(a){var b;b=x(a,", ")?", ":x(a,",")?",":x(a,"|")?"|":" ";return a.split(b)}var x=function(){var a=String.prototype.includes?function(b,a){return b.includes(a)}:function(a,
f){return-1!==a.indexOf(f)};return function(b,f){f=String(f);return b?f?a(b,f):!0:!f}}(),p=function(){var a=Object.prototype.hasOwnProperty;return function(b,f){return!!b&&a.call(b,f)}}(),y=function(){function a(D,d,k,a,c,q){var n,h;if(!is.obj(D))throw g.type("obj");is.str(d)&&(d=u(d));if(!is.obj(d))throw g.type("props");n=is.arr(d);h=arguments.length;if(n&&3>h)throw g("No val defined");!n&&2<h&&(q=c,c=a,a=k,k=r,++h);if(4===h||5===h)h=b(h,a,c,q),a=h[0],c=h[1],q=h[2];if(!is("!obj=",a))throw g.type("descriptor");
if(!is("str=",c))throw g.type("strongType");if(!is("func=",q))throw g.type("setter");if(c){if(n&&!is(c+"=",k))throw g("The val param is not a valid strongType");if(!n&&!f(c,d))throw g("A props value was not a valid strongType");}return e(D,d,k,a,c,q)}function b(D,d,k,a){switch(D){case 4:is.str(d)?(k=d,d=r):is.func(d)&&(a=d,d=r);break;case 5:is.func(k)&&(a=k,k=r,is.str(d)&&(k=d,d=r))}return[d,k,a]}function f(a,d){var k,c;a+="=";for(k in d)if(p(d,k)){c=d[k];if(is.obj(c)&&x(c)){if(p(c,"writable"))continue;
c=c.value}if(!is(a,c))return!1}return!0}function e(a,d,k,b,e,q){b=y(b||null,!!e||!!q);e=z(e);if(is.arr(d))if(e||q){var n=d,h=b,g;b={};d=n.length;for(g=-1;++g<d;)b[n[g]]=w(k,h,e,q);q=b}else q=c(d,k,b);else if(e||q){h=d;k=b;b={};for(n in h)if(p(h,n)){d=b;g=n;var f;a:{f=h[n];var l=e,r=q,v=void 0,v=t({},k);if(x(f)){v=t(v,f);if(p(v,"writable")||E(v)){f=v;break a}f=v.value;var B=void 0,m=void 0,B={};for(m in v)p(v,m)&&"value"!==m&&(B[m]=v[m]);v=B}f=v=G(f,v,l,r)}d[g]=f}q=b}else{q=d;n=b;k={};for(h in q)p(q,
h)&&(e=k,b=h,d=q[h],g=void 0,g=t({},n),d=x(d)?d:{value:d},d=t(g,d),e[b]=d);q=k}return F(a,q)}function c(a,d,k){var b,c,e,g;b=E(k)?function(d,k){return t({},k)}:B;c={};e=a.length;for(g=-1;++g<e;)c[a[g]]=b(d,k);return c}function l(a,d){var k,c,b;k={};c=a.length;for(b=-1;++b<c;)k[a[b]]=d;return k}function B(a,d){var k;k=t({},d);k.value=a;return k}function w(a,d,k,b){d=t({},d);return d=G(a,d,k,b)}function G(a,d,k,b){var c;d.get=function(){return a};d.set=k&&b?function(d){if(!k(d))throw c=new TypeError("Invalid type for object property value."),
c.__setter=!0,c.__type=!0,c;a=b(d,a)}:k?function(d){if(!k(d))throw c=new TypeError("Invalid type for object property value."),c.__setter=!0,c.__type=!0,c;a=d}:function(d){a=b(d,a)};return d}function x(a){var d;if(!is.obj(a))return!1;for(d in a)if(p(a,d)&&!p(J,d))return!1;return!0}function E(a){return p(a,"get")||p(a,"set")}function y(a,d){var c;if(c=d)c=a,c=p(c,"value")||p(c,"writable");c&&(c={},is.bool(a.enumerable)&&(c.enumerable=a.enumerable),is.bool(a.configurable)&&(c.configurable=a.configurable),
a=c);c=d||E(a)?K:C;c=t({},c);return t(c,a)}function z(a){return a&&function(d){return is(a,d)}}function A(a,d){for(var c in d)if(p(d,c)&&!p(a,c))return!1;return!0}a.config=function(a,d,c){if(!is.obj(a))throw g.type("obj","config");is.str(d)&&(d=u(d));if(!is.obj(d))throw g.type("props","config");if(is.arr(d)){if(!is.obj(c))throw g.type("descriptor","config");d=l(d,c)}if(!A(a,d))throw g("A given prop was not defined in the obj","config");return F(a,d)};a.property=function(a,d,c,b,e,f){var n;if(!is.obj(a))throw g.type("obj",
"property");if(!is.str(d))throw g.type("key","property");n=arguments.length;if(3>n)throw g("No val or descriptor defined","property");if(2<n&&6>n){var h=c,l=b,m=e,u=f;switch(n){case 4:is.str(l)?(m=l,l=r):is.func(l)&&(u=l,l=r);break;case 5:is.func(m)&&(u=m,m=r,is.str(l)&&(m=l,l=r))}is.obj(h)&&x(h)&&(l=h,h=l.value);n=[h,l,m,u];c=n[0];b=n[1];e=n[2];f=n[3]}if(!is("!obj=",b))throw g.type("descriptor","property");if(!is("str=",e))throw g.type("strongType","property");if(!is("func=",f))throw g.type("setter",
"property");if(e&&!is(e+"=",c))throw g("The val param is not a valid strongType","property");if(b&&(e||f)&&p(b,"writable"))throw g("A data descriptor may not be used with a strongType/setter","property");n=c;l=e;m=f;h=b||null;h=y(h,!!l||!!m);h=(l=z(l))||m?w(n,h,l,m):E(h)?t({},h):B(n,h);return H(a,d,h)};a.prop=a.property;a.property.config=function(a,d,c){if(!is.obj(a))throw g.type("obj","property.config");if(!is.str(d))throw g.type("key","property.config");if(!is.obj(c))throw g.type("descriptor","property.config");
if(!p(a,d))throw g("The key was not defined in the obj","property.config");return H(a,d,c)};a.prop.config=a.property.config;a.properties=function(a,d,c,l,m,q){var n,h;if(!is.obj(a))throw g.type("obj","properties");is.str(d)&&(d=u(d));if(!is.obj(d))throw g.type("props","properties");n=is.arr(d);h=arguments.length;if(n&&3>h)throw g("No val defined","properties");!n&&2<h&&(q=m,m=l,l=c,c=r,++h);if(4===h||5===h)h=b(h,l,m,q),l=h[0],m=h[1],q=h[2];if(!is("!obj=",l))throw g.type("descriptor","properties");
if(!is("str=",m))throw g.type("strongType","properties");if(!is("func=",q))throw g.type("setter","properties");if(m){if(n&&!is(m+"=",c))throw g("The val param is not a valid strongType","properties");if(!n&&!f(m,d))throw g("A props value was not a valid strongType","properties");}return e(a,d,c,l,m,q)};a.props=a.properties;a.properties.config=function(a,c,b){if(!is.obj(a))throw g.type("obj","properties.config");is.str(c)&&(c=u(c));if(!is.obj(c))throw g.type("props","properties.config");if(is.arr(c)){if(!is.obj(b))throw g.type("descriptor",
"properties.config");c=l(c,b)}if(!A(a,c))throw g("A given prop was not defined in the obj","properties.config");return F(a,c)};a.props.config=a.properties.config;var C={writable:!0,enumerable:!0,configurable:!0},K={enumerable:!0,configurable:!0},J={get:!0,set:!0,value:!0,writable:!0,enumerable:!0,configurable:!0},I=!!Object.defineProperties&&function(){var a,c,b;c={};a={enumerable:!1,value:c};try{for(b in Object.defineProperty(c,"prop",a),c)if("prop"===b)return!1}catch(e){return!1}return c.prop===
c}(),H=I?Object.defineProperty:function(c,a,b){c[a]=p(b,"get")?b.get():b.value;return c},F=I?Object.defineProperties:function(c,a){var b,e;for(e in a)p(a,e)&&(b=a[e],c[e]=p(b,"get")?b.get():b.value);return c},g=m("amend");return a}(),z=function(){function a(c,a,b,m,p,r){var t;if(!is("?obj",c))throw e.type("proto");return 1<arguments.length?(t=w(arguments),t[0]=f(c),y.apply(null,t)):f(c)}function b(){}a.object=function(a,b,m,p,r,t){var u;if(!is("?obj",a))throw e.type("proto","object");return 1<arguments.length?
(u=w(arguments),u[0]=f(a),y.apply(null,u)):f(a)};a.obj=a.object;var f=Object.create||function(a){b.prototype=a;a=new b;b.prototype=null;return a},e=m("create");return a}(),A=function(){function a(a,l){if(is.nil(a))return null;if(!is._obj(a))throw e.type("obj");if(!is("bool=",l))throw e.type("deep");return l?b(a):f(a)}function b(a){for(var e in a)p(a,e)&&is._obj(a[e])&&(a[e]=b(a[e]));return f(a)}a.object=function(a,l){if(is.nil(a))return null;if(!is._obj(a))throw e.type("obj","object");if(!is("bool=",
l))throw e.type("deep","object");return l?b(a):f(a)};a.obj=a.object;var f=function(){if(!Object.freeze)return function(a){return a};try{Object.freeze(function(){})}catch(a){return function(a){return is.func(a)?a:Object.freeze(a)}}return Object.freeze}(),e=m("freeze");return a}(),C=function(){function a(a,l){if(is.nil(a))return null;if(!is._obj(a))throw e.type("obj");if(!is("bool=",l))throw e.type("deep");return l?f(a):b(a)}a.object=function(a,l){if(is.nil(a))return null;if(!is._obj(a))throw e.type("obj",
"seal");if(!is("bool=",l))throw e.type("deep","seal");return l?f(a):b(a)};a.obj=a.object;var b=Object.seal?Object.seal:function(a){return a},f=Object.seal?function l(a){var e,f;for(e in a)p(a,e)&&(f=a[e],is._obj(f)&&(a[e]=l(f)));return b(a)}:function(a){return a},e=m("seal");return a}();return{amend:y,create:z,freeze:A,seal:C}}());
