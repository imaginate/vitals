...
e=e.value}if(!is(a,e))return!1}return!0}function d(a,c,k,b,d,r){b=y(b||null,!!d||!!r);d=z(d);if(is.arr(c))if(d||r){var m=c,h=b,g;b={};c=m.length;for(g=-1;++g<c;)b[m[g]]=w(k,h,d,r);r=b}else r=e(c,k,b);else if(d||r){h=c;k=b;b={};for(m in h)if(q(h,m)){c=b;g=m;var f;a:{f=h[m];var l=d,u=r,n=void 0,n=v({},k);if(x(f)){n=v(n,f);if(q(n,"writable")||D(n)){f=n;break a}f=n.value;var t=void 0,p=void 0,t={};for(p in n)q(n,p)&&"value"!==p&&(t[p]=n[p]);n=t}f=n=F(f,n,l,u)}c[g]=f}r=b}else{r=c;m=b;k={};for(h in r)q(r,
h)&&(d=k,b=h,c=r[h],g=void 0,g=v({},m),c=x(c)?c:{value:c},c=v(g,c),d[b]=c);r=k}return E(a,r)}function e(a,c,k){var b,e,d,g;b=D(k)?function(c,k){return v({},k)}:n;e={};d=a.length;for(g=-1;++g<d;)e[a[g]]=b(c,k);return e}function l(a,c){var k,b,e;k={};b=a.length;for(e=-1;++e<b;)k[a[e]]=c;return k}function n(a,c){var k;k=v({},c);k.value=a;return k}function w(a,c,k,e){c=v({},c);return c=F(a,c,k,e)}function F(a,c,k,e){var b;c.get=function(){return a};c.set=k&&e?function(c){if(!k(c))throw b=new TypeError("Invalid type for object property value."),
...
a=b);b=c||D(a)?J:B;b=v({},b);return v(b,a)}function z(a){return a&&function(c){return is(a,c)}}function A(a,c){for(var b in c)if(q(c,b)&&!q(a,b))return!1;return!0}a.config=function(a,c,b){if(!is.obj(a))throw g.type("obj","config");is.str(c)&&(c=p(c));if(!is.obj(c))throw g.type("props","config");if(is.arr(c)){if(!is.obj(b))throw g.type("descriptor","config");c=l(c,b)}if(!A(a,c))throw g("A given prop was not defined in the obj","config");return E(a,c)};a.property=function(a,c,b,e,d,f){var m;if(!is.obj(a))throw g.type("obj",
"property");if(!is.str(c))throw g.type("key","property");m=arguments.length;if(3>m)throw g("No val or descriptor defined","property");if(2<m&&6>m){var h=b,l=e,p=d,t=f;switch(m){case 4:is.str(l)?(p=l,l=u):is.func(l)&&(t=l,l=u);break;case 5:is.func(p)&&(t=p,p=u,is.str(l)&&(p=l,l=u))}is.obj(h)&&x(h)&&(l=h,h=l.value);m=[h,l,p,t];b=m[0];e=m[1];d=m[2];f=m[3]}if(!is("!obj=",e))throw g.type("descriptor","property");if(!is("str=",d))throw g.type("strongType","property");if(!is("func=",f))throw g.type("setter",
"property");if(d&&!is(d+"=",b))throw g("The val param is not a valid strongType","property");if(e&&(d||f)&&q(e,"writable"))throw g("A data descriptor may not be used with a strongType/setter","property");m=b;l=d;p=f;h=e||null;h=y(h,!!l||!!p);h=(l=z(l))||p?w(m,h,l,p):D(h)?v({},h):n(m,h);return G(a,c,h)};a.prop=a.property;a.property.config=function(a,c,b){if(!is.obj(a))throw g.type("obj","property.config");if(!is.str(c))throw g.type("key","property.config");if(!is.obj(b))throw g.type("descriptor","property.config");
if(!q(a,c))throw g("The key was not defined in the obj","property.config");return G(a,c,b)};a.prop.config=a.property.config;a.properties=function(a,c,e,l,n,r){var m,h;if(!is.obj(a))throw g.type("obj","properties");is.str(c)&&(c=p(c));if(!is.obj(c))throw g.type("props","properties");m=is.arr(c);h=arguments.length;if(m&&3>h)throw g("No val defined","properties");!m&&2<h&&(r=n,n=l,l=e,e=u,++h);if(4===h||5===h)h=b(h,l,n,r),l=h[0],n=h[1],r=h[2];if(!is("!obj=",l))throw g.type("descriptor","properties");
if(!is("str=",n))throw g.type("strongType","properties");if(!is("func=",r))throw g.type("setter","properties");if(n){if(m&&!is(n+"=",e))throw g("The val param is not a valid strongType","properties");if(!m&&!f(n,c))throw g("A props value was not a valid strongType","properties");}return d(a,c,e,l,n,r)};a.props=a.properties;a.properties.config=function(a,c,b){if(!is.obj(a))throw g.type("obj","properties.config");is.str(c)&&(c=p(c));if(!is.obj(c))throw g.type("props","properties.config");if(is.arr(c)){if(!is.obj(b))throw g.type("descriptor",
...
b}(),G=H?Object.defineProperty:function(a,b,e){a[b]=q(e,"get")?e.get():e.value;return a},E=H?Object.defineProperties:function(a,b){var e,d;for(d in b)q(b,d)&&(e=b[d],a[d]=q(e,"get")?e.get():e.value);return a},g=t("amend");return a}(),z=function(){function a(a,b,n,p,q,u){var t;if(!is("?obj",a))throw d.type("proto");return 1<arguments.length?(t=w(arguments),t[0]=f(a),y.apply(null,t)):f(a)}function b(){}a.object=function(a,b,n,p,q,u){var t;if(!is("?obj",a))throw d.type("proto","object");return 1<arguments.length?
(t=w(arguments),t[0]=f(a),y.apply(null,t)):f(a)};a.obj=a.object;var f=Object.create||function(a){b.prototype=a;a=new b;b.prototype=null;return a},d=t("create");return a}(),A=function(){function a(a,l){if(is.nil(a))return null;if(!is._obj(a))throw d.type("obj");if(!is("bool=",l))throw d.type("deep");return l?b(a):f(a)}function b(a,d){for(var n in a)q(a,n)&&is._obj(a[n])&&b(a[n]);return f(a)}a.object=function(a,l){if(is.nil(a))return null;if(!is._obj(a))throw d.type("obj","object");if(!is("bool=",l))throw d.type("deep",
"object");return l?b(a):f(a)};a.obj=a.object;var f=function(){if(!Object.freeze)return function(a){return a};try{Object.freeze(function(){})}catch(a){return function(a){return is.func(a)?a:Object.freeze(a)}}return Object.freeze}(),d=t("freeze");return a}(),B=function(){function a(a,l){if(is.nil(a))return null;if(!is._obj(a))throw d.type("obj");if(!is("bool=",l))throw d.type("deep");return l?f(a):b(a)}a.object=function(a,l){if(is.nil(a))return null;if(!is._obj(a))throw d.type("obj","seal");if(!is("bool=",
l))throw d.type("deep","seal");return l?f(a):b(a)};a.obj=a.object;var b=Object.seal?Object.seal:function(a){return a},f=Object.seal?function l(a){var d,f;for(d in a)q(a,d)&&(f=a[d],is._obj(f)&&(a[d]=l(f)));return b(a)}:function(a){return a},d=t("seal");return a}();return{amend:y,create:z,freeze:A,seal:B}}());
