...
/* vitals-configure.js v2.0.0 (https://github.com/imaginate/vitals)
 * Copyright (c) 2015 Adam A Smith <adam@imaginate.life>
 * The Apache License (https://github.com/imaginate/vitals/blob/master/LICENSE.md) */
(function(q,t){function n(a,b){return"object"===a||!b&&"function"===a}function u(a,b){return(a=a&&b&&a.nodeType?!1:a)&&!b&&a.Object!==Object?!1:!!a}function x(a){a.vitals=t;a.Vitals=t}var r=n(typeof exports)&&u(exports,!0),l=n(typeof module)&&u(module,!0),y=n(typeof global,!0)&&u(global),z=n(typeof window)&&u(window),A=n(typeof self)&&u(self),C=n(typeof q)&&u(q);q=r&&l&&y?global:z&&window!==(q&&q.window)?window:A?self:C?q:Function("return this")();z&&x(window);A&&x(self);x(q);r&&l&&(module.exports===
exports?module.exports=t:x(exports));"function"===typeof define&&define.amd&&"object"===typeof define.amd&&define(function(){return t})})(this,function(q){function t(a){var b;a="vitals."+a;b=function(b,d){d=d||"";d=a+(d&&".")+d;return Error(b+" for "+d+" call.")};b.type=function(b,d){d=d||"";d=a+(d&&".")+d;return new TypeError("Invalid "+(b+" param")+" in "+d+" call.")};b.range=function(b,d,f){f=f||"";f=a+(f&&".")+f;b="The "+(b+" param")+" was out-of-range for a "+f+" call.";return new RangeError(b+
(d?" The valid options are: "+d:""))};return b}function n(a,b,e){for(var d in b)l(b,d)&&(a[d]=b[d]);return a}function u(a,b,e){var d,f;d=a.length;b=b?0>b?d+b:b:0;b=0>b?0:b;e=is.undefined(e)||e>d?d:0>e?d+e:e;if(b>=e)return[];d=Array(e-b);--b;for(f=0;++b<e;)d[f++]=a[b];return d}function x(a){var b;b=r(a,", ")?", ":r(a,",")?",":r(a,"|")?"|":" ";return a.split(b)}var r=function(){var a=String.prototype.includes?function(b,a){return b.includes(a)}:function(b,a){return-1!==b.indexOf(a)};return function(b,
...
function d(a,c,m,b,v,d){b=F(b||null,!!v||!!d);v=z(v);if(is.arr(c))if(v||d){var k=c,g=b,e;b={};c=k.length;for(e=-1;++e<c;)b[k[e]]=u(m,g,v,d);d=b}else d=f(c,m,b);else if(v||d){k=c;m=b;b={};for(g in k)l(k,g)&&(b[g]=h(k[g],m,v,d));d=b}else{d=c;m=b;v={};for(k in d)l(d,k)&&(g=v,b=k,c=d[k],e=void 0,e=n({},m),c=D(c)?c:{value:c},c=n(e,c),g[b]=c);d=v}return I(a,d)}function f(b,c,m){var a,f,d,e;a=r(m)?function(c,b){return n({},b)}:G;f={};d=b.length;for(e=-1;++e<d;)f[b[e]]=a(c,m);return f}function h(b,c,m,a){c=
n({},c);if(D(b)){c=n(c,b);if(l(c,"writable")||r(c))return c;b=c.value;c=y(c)}c.get=function(){return b};c.set=m&&a?function(c){m(c)&&(b=a(c,b))}:m?function(c){m(c)&&(b=c)}:function(c){b=a(c,b)};return c}function G(b,c){var a;a=n({},c);a.value=b;return a}function u(b,c,a,f){c=n({},c);c.get=function(){return b};c.set=a&&f?function(c){a(c)&&(b=f(c,b))}:a?function(c){a(c)&&(b=c)}:function(c){b=f(c,b)};return c}function D(b){var c;if(!is.obj(b))return!1;for(c in b)if(l(b,c)&&!l(J,c))return!1;return!0}
function r(b){return l(b,"get")||l(b,"set")}function F(b,c){var a;if(a=c)a=b,a=l(a,"value")||l(a,"writable");a&&(a={},is.bool(b.enumerable)&&(a.enumerable=b.enumerable),is.bool(b.configurable)&&(a.configurable=b.configurable),b=a);a=c||r(b)?C:A;a=n({},a);return n(a,b)}function y(b){var c,a;c={};for(a in b)l(b,a)&&"value"!==a&&(c[a]=b[a]);return c}function z(b){return b&&function(c){return is(b,c)}}a.property=function(b,c,a,f,d,e){var k;if(!is.obj(b))throw p.type("obj","property");if(!is.str(c))throw p.type("key",
"property");k=arguments.length;if(3>k)throw p("No val or descriptor defined","property");if(2<k&&6>k){var g=a,h=f,w=d,t=e;switch(k){case 4:is.str(h)?(w=h,h=q):is.func(h)&&(t=h,h=q);break;case 5:is.func(w)&&(t=w,w=q,is.str(h)&&(w=h,h=q))}is.obj(g)&&D(g)&&(h=g,g=h.value);k=[g,h,w,t];a=k[0];f=k[1];d=k[2];e=k[3]}if(!is("!obj=",f))throw p.type("descriptor","property");if(!is("str=",d))throw p.type("staticType","property");if(!is("func=",e))throw p.type("setter","property");if(d&&!is(d+"=",a))throw p("The val param is not a valid staticType",
"property");if(f&&(d||e)&&l(f,"writable"))throw p("A data descriptor may not be used with a staticType/setter","property");k=a;h=d;w=e;g=f||null;g=F(g,!!h||!!w);g=(h=z(h))||w?u(k,g,h,w):r(g)?n({},g):G(k,g);return K(b,c,g)};a.prop=a.property;a.properties=function(a,c,f,h,l,n){var k,g;if(!is.obj(a))throw p.type("obj","properties");is.str(c)&&(c=x(c));if(!is.obj(c))throw p.type("props","properties");k=is.arr(c);g=arguments.length;if(k&&3>g)throw p("No val defined","properties");!k&&2<g&&(n=l,l=h,h=f,
f=q,++g);if(4===g||5===g)g=b(g,h,l,n),h=g[0],l=g[1],n=g[2];if(!is("!obj=",h))throw p.type("descriptor","properties");if(!is("str=",l))throw p.type("staticType","properties");if(!is("func=",n))throw p.type("setter","properties");if(l){if(k&&!is(l+"=",f))throw p("The val param is not a valid staticType","properties");if(!k&&!e(l,c))throw p("A props value was not a valid staticType","properties");}return d(a,c,f,h,l,n)};a.props=a.properties;var A={writable:!0,enumerable:!0,configurable:!0},C={enumerable:!0,
configurable:!0},J={get:!0,set:!0,value:!0,writable:!0,enumerable:!0,configurable:!0},H=!!Object.defineProperties&&function(){var b,a,f;a={};b={enumerable:!1,value:a};try{for(f in Object.defineProperty(a,"prop",b),a)if("prop"===f)return!1}catch(d){return!1}return a.prop===a}(),K=H?Object.defineProperty:function(b,a,f){b[a]=l(f,"get")?f.get():f.value;return b},I=H?Object.defineProperties:function(b,a){var f,d;for(d in a)l(a,d)&&(f=a[d],b[d]=l(f,"get")?f.get():f.value);return b},p=t("amend");return a}(),
z=function(){function a(b,a,l,n,q,t){var r;if(!is("?obj",b))throw d.type("proto");return 1<arguments.length?(r=u(arguments),r[0]=e(b),y.apply(null,r)):e(b)}function b(){}a.object=function(b,a,l,n,q,r){if(!is("?obj",b))throw d.type("proto","object");return 1<arguments.length?(args=u(arguments),args[0]=e(b),y.apply(null,args)):e(b)};a.obj=a.object;var e=Object.create||function(a){b.prototype=a;a=new b;b.prototype=null;return a},d=t("create");return a}(),A=function(){function a(a,h){if(is.nil(a))return null;
if(!is._obj(a))throw d.type("obj");if(!is("bool=",h))throw d.type("deep");return h?b(a):e(a)}function b(a){for(var d in a)l(a,d)&&is._obj(a[d])&&(a[d]=b(a[d]));return e(a)}a.object=function(a,h){if(is.nil(a))return null;if(!is._obj(a))throw d.type("obj","object");if(!is("bool=",h))throw d.type("deep","object");return h?b(a):e(a)};a.obj=a.object;var e=function(){if(!Object.freeze)return function(a){return a};try{Object.freeze(function(){})}catch(a){return function(a){return is.func(a)?a:Object.freeze(a)}}return Object.freeze}(),
d=t("freeze");return a}(),C=function(){function a(a,h){if(is.nil(a))return null;if(!is._obj(a))throw d.type("obj");if(!is("bool=",h))throw d.type("deep");return h?e(a):b(a)}a.object=function(a,h){if(is.nil(a))return null;if(!is._obj(a))throw d.type("obj","seal");if(!is("bool=",h))throw d.type("deep","seal");return h?e(a):b(a)};a.obj=a.object;var b=Object.seal?Object.seal:function(a){return a},e=Object.seal?function h(a){var d,e;for(d in a)l(a,d)&&(e=a[d],is._obj(e)&&(a[d]=h(e)));return b(a)}:function(a){return a},
d=t("seal");return a}();return{amend:y,create:z,freeze:A,seal:C}}());
