...
(d?" The valid options are: "+d:""))};return b}function n(a,b,e){for(var d in b)l(b,d)&&(a[d]=b[d]);return a}function u(a,b,e){var d,f;d=a.length;b=b?0>b?d+b:b:0;b=0>b?0:b;e=e?e>d?d:0>e?d+e:e:0;if(b>=e)return[];d=Array(e-b);--b;for(f=0;++b<e;)d[f++]=a[b];return d}function x(a){var b;b=r(a,", ")?", ":r(a,",")?",":r(a,"|")?"|":" ";return a.split(b)}var r=function(){var a=String.prototype.includes?function(b,a){return b.includes(a)}:function(b,a){return-1!==b.indexOf(a)};return function(b,e){e=String(e);
return b?e?a(b,e):!0:!e}}(),l=function(){var a=Object.prototype.hasOwnProperty;return function(b,e){return!!b&&a.call(b,e)}}(),y=function(){function a(E,c,m,B,a,f){var k,g;if(!is.obj(E))throw p.type("obj");is.str(c)&&(c=x(c));if(!is.obj(c))throw p.type("props");k=is.arr(c);g=arguments.length;if(k&&3>g)throw p("No val defined");!k&&2<g&&(f=a,a=B,B=m,m=q,++g);if(4===g||5===g)g=b(g,B,a,f),B=g[0],a=g[1],f=g[2];if(!is("!obj=",B))throw p.type("descriptor");if(!is("str=",a))throw p.type("staticType");if(!is("func=",
f))throw p.type("setter");if(a){if(k&&!is(a+"=",m))throw p("The val param is not a valid staticType");if(!k&&!e(a,c))throw p("A props value was not a valid staticType");}return d(E,c,m,B,a,f)}function b(a,c,m,b){switch(a){case 4:is.str(c)?(m=c,c=q):is.func(c)&&(b=c,c=q);break;case 5:is.func(m)&&(b=m,m=q,is.str(c)&&(m=c,c=q))}return[c,m,b]}function e(a,c){var m,b;a+="=";for(m in c)if(l(c,m)){b=c[m];if(is.obj(b)&&D(b)){if(l(b,"writable"))continue;b=b.value}if(!is(a,b))return!1}return!0}function d(a,
c,m,b,v,d){b=F(b||null,!!v||!!d);v=z(v);if(is.arr(c))if(v||d){var k=c,g=b,e;b={};c=k.length;for(e=-1;++e<c;)b[k[e]]=u(m,g,v,d);d=b}else d=f(c,m,b);else if(v||d){k=c;m=b;b={};for(g in k)l(k,g)&&(b[g]=h(k[g],m,v,d));d=b}else{d=c;m=b;v={};for(k in d)l(d,k)&&(g=v,b=k,c=d[k],e=void 0,e=n({},m),c=D(c)?c:{value:c},c=n(e,c),g[b]=c);d=v}return I(a,d)}function f(b,c,m){var a,f,d,e;a=r(m)?function(c,b){return n({},b)}:G;f={};d=b.length;for(e=-1;++e<d;)f[b[e]]=a(c,m);return f}function h(b,c,m,a){c=n({},c);if(D(b)){c=
n(c,b);if(l(c,"writable")||r(c))return c;b=c.value;c=y(c)}c.get=function(){return b};c.set=m&&a?function(c){m(c)&&(b=a(c,b))}:m?function(c){m(c)&&(b=c)}:function(c){b=a(c,b)};return c}function G(b,c){var a;a=n({},c);a.value=b;return a}function u(b,c,a,f){c=n({},c);c.get=function(){return b};c.set=a&&f?function(c){a(c)&&(b=f(c,b))}:a?function(c){a(c)&&(b=c)}:function(c){b=f(c,b)};return c}function D(b){var c;if(!is.obj(b))return!1;for(c in b)if(l(b,c)&&!l(J,c))return!1;return!0}function r(b){return l(b,
"get")||l(b,"set")}function F(b,c){var a;if(a=c)a=b,a=l(a,"value")||l(a,"writable");a&&(a={},is.bool(b.enumerable)&&(a.enumerable=b.enumerable),is.bool(b.configurable)&&(a.configurable=b.configurable),b=a);a=c||r(b)?C:A;a=n({},a);return n(a,b)}function y(b){var c,a;c={};for(a in b)l(b,a)&&"value"!==a&&(c[a]=b[a]);return c}function z(b){return b&&function(c){return is(b,c)}}a.property=function(b,c,a,f,d,e){var k;if(!is.obj(b))throw p.type("obj","property");if(!is.str(c))throw p.type("key","property");
k=arguments.length;if(3>k)throw p("No val or descriptor defined","property");if(2<k&&6>k){var g=a,h=f,w=d,t=e;switch(k){case 4:is.str(h)?(w=h,h=q):is.func(h)&&(t=h,h=q);break;case 5:is.func(w)&&(t=w,w=q,is.str(h)&&(w=h,h=q))}is.obj(g)&&D(g)&&(h=g,g=h.value);k=[g,h,w,t];a=k[0];f=k[1];d=k[2];e=k[3]}if(!is("!obj=",f))throw p.type("descriptor","property");if(!is("str=",d))throw p.type("staticType","property");if(!is("func=",e))throw p.type("setter","property");if(d&&!is(d+"=",a))throw p("The val param is not a valid staticType",
