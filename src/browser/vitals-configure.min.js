...
n({},c);if(D(b)){c=n(c,b);if(l(c,"writable")||t(c))return c;b=c.value;c=y(c)}c.get=function(){return b};c.set=m&&a?function(c){m(c)&&(b=a(c,b))}:m?function(c){m(c)&&(b=c)}:function(c){b=a(c,b)};return c}function G(b,c){var a;a=n({},c);a.value=b;return a}function u(b,c,a,f){c=n({},c);c.get=function(){return b};c.set=a&&f?function(c){a(c)&&(b=f(c,b))}:a?function(c){a(c)&&(b=c)}:function(c){b=f(c,b)};return c}function D(b){var c;if(!is.obj(b))return!1;for(c in b)if(l(b,c)&&!l(J,c))return!1;return!0}
function t(b){return l(b,"get")||l(b,"set")}function F(b,c){var a;if(a=c)a=b,a=l(a,"value")||l(a,"writable");a&&(a={},is.bool(b.enumerable)&&(a.enumerable=b.enumerable),is.bool(b.configurable)&&(a.configurable=b.configurable),b=a);a=c||t(b)?C:A;a=n({},a);return n(a,b)}function y(b){var c,a;c={};for(a in b)l(b,a)&&"value"!==a&&(c[a]=b[a]);return c}function z(b){return b&&function(c){return is(b,c)}}a.property=function(b,c,a,f,d,e){var k;if(!is.obj(b))throw p.type("obj","property");if(!is.str(c))throw p.type("key",
"property");k=arguments.length;if(3>k)throw p("No val or descriptor defined","property");if(2<k&&6>k){var g=a,h=f,w=d,r=e;switch(k){case 4:is.str(h)?(w=h,h=q):is.func(h)&&(r=h,h=q);break;case 5:is.func(w)&&(r=w,w=q,is.str(h)&&(w=h,h=q))}is.obj(g)&&D(g)&&(h=g,g=h.value);k=[g,h,w,r];a=k[0];f=k[1];d=k[2];e=k[3]}if(!is("!obj=",f))throw p.type("descriptor","property");if(!is("str=",d))throw p.type("staticType","property");if(!is("func=",e))throw p.type("setter","property");if(d&&!is(d+"=",a))throw p("The val param is not a valid staticType",
...
configurable:!0},J={get:!0,set:!0,value:!0,writable:!0,enumerable:!0,configurable:!0},H=!!Object.defineProperties&&function(){var b,a,f;a={};b={enumerable:!1,value:a};try{for(f in Object.defineProperty(a,"prop",b),a)if("prop"===f)return!1}catch(d){return!1}return a.prop===a}(),K=H?Object.defineProperty:function(b,a,f){b[a]=l(f,"get")?f.get():f.value;return b},I=H?Object.defineProperties:function(b,a){var f,d;for(d in a)l(a,d)&&(f=a[d],b[d]=l(f,"get")?f.get():f.value);return b},p=r("amend");return a}(),
z=function(){function a(b,a,l,n,q,r){var t;if(!is("?obj",b))throw d.type("proto");return 1<arguments.length?(t=u(arguments),t[0]=e(b),y.apply(null,t)):e(b)}function b(){}a.object=function(b,a,l,n,q,t){var r;if(!is("?obj",b))throw d.type("proto","object");return 1<arguments.length?(r=u(arguments),r[0]=e(b),y.apply(null,r)):e(b)};a.obj=a.object;var e=Object.create||function(a){b.prototype=a;a=new b;b.prototype=null;return a},d=r("create");return a}(),A=function(){function a(a,h){if(is.nil(a))return null;
...
d=r("freeze");return a}(),C=function(){function a(a,h){if(is.nil(a))return null;if(!is._obj(a))throw d.type("obj");if(!is("bool=",h))throw d.type("deep");return h?e(a):b(a)}a.object=function(a,h){if(is.nil(a))return null;if(!is._obj(a))throw d.type("obj","seal");if(!is("bool=",h))throw d.type("deep","seal");return h?e(a):b(a)};a.obj=a.object;var b=Object.seal?Object.seal:function(a){return a},e=Object.seal?function h(a){var d,e;for(d in a)l(a,d)&&(e=a[d],is._obj(e)&&(a[d]=h(e)));return b(a)}:function(a){return a},
d=r("seal");return a}();return{amend:y,create:z,freeze:A,seal:C}}());
