/* vitals-base.js v4.0.1 (https://github.com/imaginate/vitals)
...
b=/[^a-z\|]/g,e=function(a,b,d,e,f){return{"|":function(b){return a.test(b)},"!":function(a){return b.test(a)},"?":function(a){return d.test(a)},"=":function(a){return e.test(a)},"*":function(a){return f.test(a)}}}(/\|/,/\!/,/\?/,/\=/,/\*|any/),d=w("is"),h="https://github.com/imaginate/vitals/blob/master/docs/is.js";return c}(),v=function(){function c(e,d){if(!arguments.length)throw b("Missing a val");if(!a.un.bool(d))throw b.type("deep");return a._obj(e)?a.func(e)?m(e,d):a._arr(e)?l(e,d):a.regex(e)?
...
"index");if(!a.un.num(e))throw u.type("toIndex","index");b=a.arr(b)?b:r(b);return k(b,d,e)};c.i=c.index;c.type=function(b,d){if(!a._obj(b))throw u.type("source","type");if(!a.str(d))throw u.type("type","type");try{B(d,"_")}catch(e){throw new RangeError("Invalid type value for vitals.cut.type call. See error from are: "+e.toString());}var f=b=a.args(b)?r(b):b;if(a.arr(f)){var c;for(c=f.length;c--;)B(d,f[c])&&f.splice(c,1)}else for(c in f)q(f,c)&&B(d,f[c])&&delete f[c];return f};c.value=function(b,
d){if(!a._obj(b))throw u.type("source","value");if(2>arguments.length)throw u("No val defined","value");b=a.args(b)?r(b):b;return m(b,d)};c.val=c.value;c.pattern=function(b,d){if(!a.str(b))throw u.type("source","pattern");if(2>arguments.length)throw u("No pattern defined","pattern");return n(b,d)};c.properties=function(b,d){if(!a._obj(b))throw u.type("source","properties");if(2>arguments.length)throw u("No val defined","properties");b=a.args(b)?r(b):b;d=2<arguments.length?r(arguments,1):d;return a.arr(d)?
l(b,d):g(b,d)};c.props=c.properties;c.keys=function(b,d){if(!a._obj(b))throw u.type("source","keys");if(2>arguments.length)throw u("No key defined","keys");d=2<arguments.length?r(arguments,1):d;var e;if(a.arr(d)){e=b;var f=d,c,h;c=f.length;for(h=-1;++h<c;)delete e[f[h]]}else e=b,delete e[d];return e};c.indexes=function(b,d){if(!a._obj(b))throw u.type("source","indexes");if(!a.num(b.length))throw u.type("source.length","indexes");if(2>arguments.length)throw u("No index defined","indexes");b=a.arr(b)?
b:r(b);d=2<arguments.length?r(arguments,1):d;if(!a.arr(d)){if(!a.num(d))throw u.type("index","indexes");return k(b,d)}if(!B("!nums",d))throw u.type("index","indexes");return h(b,d)};c.ii=c.indexes;c.values=function(b,d){if(!a._obj(b))throw u.type("source","value");if(2>arguments.length)throw u("No val defined","value");b=a.args(b)?r(b):b;d=2<arguments.length?r(arguments,1):d;var f;if(a.arr(d)){f=b;var c=d;f=a.arr(f)?H(f,c):e(f,c)}else f=m(b,d);return f};c.vals=c.values;c.patterns=function(b,d){if(!a.str(b))throw u.type("source",
"patterns");if(2>arguments.length)throw u("No pattern defined","patterns");d=2<arguments.length?r(arguments,1):d;return a.arr(d)?p(b,d):n(b,d)};var z=function(){function a(b,d){b=0>b?d+b:b;return 0>b||b>=d?-1:b}function b(a,f,c){var h;h=f+c>>>1;if(a<d[h]){var g,l;g=d[h];h?(c=h-1,l=e[c],a===--g?a===++l?(e[c]=e[h],d.splice(h,1),e.splice(h,1)):d[h]=a:a>l?a===++l?e[c]=a:(d.splice(h,0,a),e.splice(h,0,a)):b(a,f,c)):a===--g?d[h]=a:(d.unshift(a),e.unshift(a))}else a>e[h]&&(f=h+1,l=e[h],f===e.length?a===++l?
e[h]=a:(d.push(a),e.push(a)):(g=d[f],a===++l?a===--g?(e[h]=e[f],d.splice(f,1),e.splice(f,1)):e[h]=a:a<g?a===--g?d[f]=a:(d.splice(f,0,a),e.splice(f,0,a)):b(a,f,c)))}var d,e;return function(f,c){var h,g,l;d=[];e=[];g=f.length;l=0;for(h=a(f[l],c);-1===h&&++l<g;)h=a(f[l],c);d.push(h);for(e.push(h);++l<g;)h=a(f[l],c),-1!==h&&b(h,0,e.length);return{first:d,last:e}}}(),u=w("cut");return c}(),K=function(){function c(c,f,b){if(!a.func(f))throw n.type("iteratee");if(!a.nil.un.obj(b))throw n.type("thisArg");
if(a.num(c))return k(c,f,b);a.str(c)&&(c=y(c));if(!a._obj(c))throw n.type("source");return a._arr(c)?l(c,f,b):g(c,f,b)}function g(c,f,b){var e;c=2<f.length?v(c):c;f=a.undefined(b)?f:m(f,b);switch(f.length){case 0:for(e in c)q(c,e)&&f();break;case 1:for(e in c)q(c,e)&&f(c[e]);break;case 2:for(e in c)q(c,e)&&f(c[e],e);break;default:for(e in c)q(c,e)&&f(c[e],e,c)}return c}function l(c,f,b){var e;c=2<f.length?v.arr(c):c;f=a.undefined(b)?f:m(f,b);b=c.length;e=-1;switch(f.length){case 0:for(;++e<b;)f();
break;case 1:for(;++e<b;)f(c[e]);break;case 2:for(;++e<b;)f(c[e],e);break;default:for(;++e<b;)f(c[e],e,c)}return c}function k(c,f,b){f=a.undefined(b)?f:m(f,b);if(f.length)for(b=0;c--;)f(b++);else for(;c--;)f()}function m(a,f){switch(a.length){case 0:return function(){a.call(f)};case 1:return function(b){a.call(f,b)};case 2:return function(b,e){a.call(f,b,e)}}return function(b,e,d){a.call(f,b,e,d)}}c.object=function(c,f,b){if(!a._obj(c))throw n.type("source","object");if(!a.func(f))throw n.type("iteratee",
"object");if(!a.nil.un.obj(b))throw n.type("thisArg","object");return g(c,f,b)};c.obj=c.object;c.array=function(c,f,b){a.str(c)&&(c=y(c));if(!a._obj(c))throw n.type("source","array");if(!a.num(c.length))throw n.type("source.length","array");if(!a.func(f))throw n.type("iteratee","array");if(!a.nil.un.obj(b))throw n.type("thisArg","array");return l(c,f,b)};c.arr=c.array;c.cycle=function(c,f,b){if(!a.num(c))throw n.type("count","cycle");if(!a.func(f))throw n.type("iteratee","cycle");if(!a.nil.un.obj(b))throw n.type("thisArg",
"cycle");return k(c,f,b)};c.time=c.cycle;var n=w("each");return c}(),L=function(){function c(c,f,b,e,d){if(2>arguments.length)throw n("No val defined");if(a.nil(c))return null;if(a.num(c))return m(c,f);if(!a._obj(c))throw n.type("source");if(a.arr(c)){d=e;e=b;b=f;if(!a.un.num(e))throw n.type("start");if(!a.un.num(d))throw n.type("end");return k(c,b,e,d)}if(2<arguments.length){f=a.str(f)?y(f):f;if(!a.arr(f))throw n.type("keys");return l(c,f,b)}return g(c,f)}function g(a,f){for(var b in a)q(a,b)&&(a[b]=
f);return a}function l(a,f,b){var e,d;e=f.length;for(d=-1;++d<e;)a[f[d]]=b;return a}function k(a,f,b,e){var d;d=a.length;b=b||0;b=0>b?d+b:b;b=0>b?0:b;e=e||d;e=e>d?d:0>e?d+e:e;if(b>=e)return a;for(--b;++b<e;)a[b]=f;return a}function m(a,f){var b;a=0>a?0:a;if(!a)return"";f=String(f);for(b="";a--;)b+=f;return b}c.object=function(c,f,b){if(!a._obj(c))throw n.type("obj","object");if(2>arguments.length)throw n("No val defined","object");if(2<arguments.length){f=a.str(f)?y(f):f;if(!a.arr(f))throw n.type("keys",
"object");return l(c,f,b)}return g(c,f)};c.obj=c.object;c.array=function(c,f,b,e){c=a.num(c)?Array(c):c;if(2>arguments.length)throw n("No val defined","array");if(!a.arr(c))throw n.type("arr","array");if(!a.un.num(b))throw n.type("start","array");if(!a.un.num(e))throw n.type("end","array");return k(c,f,b,e)};c.arr=c.array;c.string=function(c,f){if(!a.num(c))throw n.type("count","string");if(2>arguments.length)throw n("No val defined","string");return m(c,f)};c.str=c.string;var n=w("fill");return c}(),
M=function(){function c(b,e){if(2>arguments.length)throw f("No val defined");if(a.str(b))return e=2<arguments.length?r(arguments,1):e,a.arr(e)?p(b,e):b+e;if(!a._obj(b))throw f.type("dest");b=a.args(b)?r(b):b;if(a.arr(b))return 2<arguments.length?(e=r(arguments,1),n(b,e)):m(b,e);e=2<arguments.length?r(arguments,1):e;return a.arr(e)?l(b,e):g(b,e)}function g(b,e){if(a._obj(e))return x(b,e);a.nil(e)||(b[e]=t);return b}function l(a,e){var d,f;d=e.length;for(f=-1;++f<d;)a=g(a,e[f]);return a}function k(a,
e){q(a,e)||(a[e]=t);return a}function m(b,e){if(a.arr(e))return b.concat(e);a.nil(e)||b.push(e);return b}function n(a,e){var d,f;d=e.length;for(f=-1;++f<d;)a=m(a,e[f]);return a}function p(a,e){var d,f;d=e.length;for(f=-1;++f<d;)a+=e[f];return a}c.value=function(b,e){if(2>arguments.length)throw f("No val defined","value");if(a.str(b)){if(3>arguments.length)return b+e;e=r(arguments,1);return p(b,e)}if(!a._obj(b))throw f.type("dest","value");b=a.args(b)?r(b):b;if(3>arguments.length){var d;a.arr(b)?(d=
b,d.push(e)):(d=b,d[e]=t);return d}e=r(arguments,1);if(a.arr(b)){d=b;var c=e,g,l;g=c.length;for(l=-1;++l<g;)d.push(c[l])}else{d=b;var c=e,k;l=c.length;for(k=-1;++k<l;)g=c[k],d[g]=t}return d};c.val=c.value;c.value.start=function(b,e){if(2>arguments.length)throw f("No val defined","value.start");if(a.str(b)){if(3>arguments.length)return e+b;e=r(arguments,1);var d=b,c,g;c=e.length;for(g=-1;++g<c;)d=e[g]+d;return d}if(!a._obj(b))throw f.type("dest","value.start");b=a.args(b)?r(b):b;if(3>arguments.length)return a.arr(b)?
(d=b,d.unshift(e)):d=k(b,e),d;e=r(arguments,1);if(a.arr(b)){d=b;c=e;var l;g=c.length;for(l=-1;++l<g;)d.unshift(c[l])}else for(d=b,c=e,g=c.length,l=-1;++l<g;)d=k(d,c[l]);return d};c.val.start=c.value.start;c.value.top=c.value.start;c.val.top=c.value.start;c.object=function(b,e){if(!a._obj(b))throw f.type("dest","object");if(2>arguments.length)throw f("No val defined","object");e=2<arguments.length?r(arguments,1):e;return a.arr(e)?l(b,e):g(b,e)};c.obj=c.object;c.array=function(b,e){if(!a._arr(b))throw f.type("dest",
"array");if(2>arguments.length)throw f("No val defined","array");b=a.args(b)?r(b):b;return 2<arguments.length?(e=r(arguments,1),n(b,e)):m(b,e)};c.arr=c.array;c.string=function(b,e){if(!a.str(b))throw f.type("dest","string");if(2>arguments.length)throw f("No val defined","string");e=2<arguments.length?r(arguments,1):e;return a.arr(e)?p(b,e):b+e};c.str=c.string;var f=w("fuse");return c}(),N=function(){function c(d,c){if(a.str(d)){if(2>arguments.length)throw e("No val defined");return a.regex(c)?b(d,
c):f(d,c)}if(!a._obj(d))throw e.type("source");return 2>arguments.length?a._arr(d)?n(d):g(d):a._arr(d)?p(d,c):a.regex(c)?m(d,c):k(d,c)}function g(a){var b,e;b=[];for(e in a)q(a,e)&&b.push(e);return b}function l(b,e){var f,c;e=a.regex(e)?e:String(e);f=[];for(c in b)q(b,c)&&A(c,e)&&f.push(c);return f}function k(a,b){var e,f;e=[];for(f in a)q(a,f)&&a[f]===b&&e.push(f);return e}function m(b,e){var f,c;e=a.regex(e)?e:String(e);f=[];for(c in b)q(b,c)&&A(c,e)&&f.push(b[c]);return f}function n(a){var b,e;
b=a.length;a=Array(b);for(e=-1;++e<b;)a[e]=e;return a}function p(a,b){var e,f,c;f=a.length;e=[];for(c=-1;++c<f;)a[c]===b&&e.push(c);return e}function f(b,e){var f;if(A(b,e)){if(a.regex(e)){var c,g;f=v.regex(e,!0);c=[];for(g=f.exec(b);g;)c.push(g.index),g=f.exec(b)}else for(f=String(e),c=[],g=b.indexOf(f);-1!==g;)c.push(g),g=b.indexOf(f,++g);f=c}else f=[];return f}function b(b,e){var f;if(A(b,e)){if(a.regex(e)){var c,g;f=v.regex(e,!0);c=[];for(g=f.exec(b);g;)c.push(g[0]),g=f.exec(b)}else for(f=String(e),
c=[],g=b.indexOf(f);-1!==g;)c.push(f),g=b.indexOf(f,++g);f=c}else f=[];return f}c.keys=function(b,f){if(!a._obj(b))throw e.type("source","keys");return 2>arguments.length?g(b):a.regex(f)?l(b,f):k(b,f)};c.keys.byKey=function(b,f){if(!a._obj(b))throw e.type("source","keys.byKey");if(2>arguments.length)throw e("No pattern defined","keys.byKey");return l(b,f)};c.keys.byValue=function(b,f){if(!a._obj(b))throw e.type("source","keys.byValue");if(2>arguments.length)throw e("No val defined","keys.byValue");
return k(b,f)};c.keys.byVal=c.keys.byValue;c.indexes=function(b,c){if(a.str(b)){if(2>arguments.length)throw e("No val defined","indexes");return f(b,c)}if(!a._obj(b))throw e.type("source","indexes");if(!a.num(b.length))throw e.type("source.length","indexes");return 2>arguments.length?n(b):p(b,c)};c.ii=c.indexes;c.values=function(d,f){if(a.str(d)){if(2>arguments.length)throw e("No val defined","values");return b(d,f)}if(!a._obj(d))throw e.type("source","values");var c;if(2>arguments.length){var g;
c=[];for(g in d)q(d,g)&&c.push(d[g])}else c=m(d,f);return c};c.vals=c.values;var e=w("get");return c}(),O=function(){function c(c,k){if(2>arguments.length)throw g("No val defined");if(a.nil(c))return!1;if(a.str(c))return A(c,k);if(!a._obj(c))throw g.type("source");return a._arr(c)?z(c,k):q(c,k)}c.key=function(c,k){if(2>arguments.length)throw g("No key defined","key");if(a.nil(c))return!1;if(!a._obj(c))throw g.type("source","key");return q(c,k)};c.value=function(c,k){if(2>arguments.length)throw g("No val defined",
"value");if(a.nil(c))return!1;if(!a._obj(c))throw g.type("source","value");return a._arr(c)?z(c,k):E(c,k)};c.val=c.value;c.pattern=function(c,k){if(!a.str(c))throw g.type("source","pattern");if(2>arguments.length)throw g("No pattern defined","pattern");return A(c,k)};c.substring=function(c,k){if(!a.str(c))throw g.type("source","substring");if(2>arguments.length)throw g("No val defined","substring");return F(c,k)};c.substr=c.substring;c.enumerable=function(c,k){if(2>arguments.length)throw g("No key defined",
"enumerable");if(a.nil(c))return!1;if(!a._obj(c))throw g.type("source","enumerable");return I(c,k)};try{c["enum"]=c.enumerable}catch(l){}var g=w("has");return c}(),P=function(){function c(f,b,e,d){if(a.str(f)){if(2>arguments.length)throw p("No iteratee defined");if(3>arguments.length)throw p("No replacement defined");if(!a.nil.un.obj(d))throw p.type("thisArg");return k(f,b,e,d)}d=e;if(!a._obj(f))throw p.type("source");if(!a.func(b))throw p.type("iteratee");if(!a.nil.un.obj(d))throw p.type("thisArg");
return a._arr(f)?l(f,b,d):g(f,b,d)}function g(f,b,e){var d,c;d={};f=2<b.length?v(f):f;b=a.undefined(e)?b:m(b,e);switch(b.length){case 0:for(c in f)q(f,c)&&(d[c]=b());break;case 1:for(c in f)q(f,c)&&(d[c]=b(f[c]));break;case 2:for(c in f)q(f,c)&&(d[c]=b(f[c],c));break;default:for(c in f)q(f,c)&&(d[c]=b(f[c],c,f))}return d}function l(c,b,e){var d,g;c=2<b.length?v.arr(c):c;b=a.undefined(e)?b:m(b,e);d=c.length;e=Array(d);g=-1;switch(b.length){case 0:for(;++g<d;)e[g]=b();break;case 1:for(;++g<d;)e[g]=
b(c[g]);break;case 2:for(;++g<d;)e[g]=b(c[g],g);break;default:for(;++g<d;)e[g]=b(c[g],g,c)}return e}function k(c,b,e,d){if(!c)return c;a.regex(b)||(b=String(b),b=D(b),b=new RegExp(b,"g"));e=a.func(e)?a.undefined(d)?e:n(e,d):String(e);return c.replace(b,e)}function m(a,b){switch(a.length){case 0:return function(){return a.call(b)};case 1:return function(e){return a.call(b,e)};case 2:return function(e,d){return a.call(b,e,d)}}return function(e,d,c){return a.call(b,e,d,c)}}function n(a,b){switch(a.length){case 0:return function(){return a.call(b)};
case 1:return function(e){return a.call(b,e)};case 2:return function(e,d){return a.call(b,e,d)};case 3:return function(e,d,c){return a.call(b,e,d,c)};case 4:return function(e,d,c,g){return a.call(b,e,d,c,g)};case 5:return function(e,d,c,g,l){return a.call(b,e,d,c,g,l)}}return function(){return a.apply(b,arguments)}}c.object=function(c,b,e){if(!a._obj(c))throw p.type("source","object");if(!a.func(b))throw p.type("iteratee","object");if(!a.nil.un.obj(e))throw p.type("thisArg","object");return g(c,b,
e)};c.obj=c.object;c.array=function(c,b,e){a.str(c)&&(c=y(c));if(!a._obj(c))throw p.type("source","array");if(!a.num(c.length))throw p.type("source.length","array");if(!a.func(b))throw p.type("iteratee","array");if(!a.nil.un.obj(e))throw p.type("thisArg","array");return l(c,b,e)};c.arr=c.array;c.string=function(c,b,e,d){if(2>arguments.length)throw p("No pattern defined","string");if(3>arguments.length)throw p("No replacement defined","string");if(!a.str(c))throw p.type("source","string");if(!a.nil.un.obj(d))throw p.type("thisArg",
"string");return k(c,b,e,d)};c.str=c.string;var p=w("remap");return c}(),Q=function(){function c(c,m,n,p){var f;if(2>arguments.length)throw l("No source or iteratee defined");2===arguments.length?(n=m,m=c):3!==arguments.length||a.func(n)?f=!0:(p=n,n=m,m=c);if(!a.func(n))throw l.type("iteratee");if(!a.nil.un.obj(p))throw l.type("thisArg");if(a.num(m)){if(!f)throw l("No base defined");var b=c,e=m,d=n,h=p,d=a.undefined(h)?d:g(d,h);if(1<d.length)for(h=0;e--;)b=d(b,h++);else for(;e--;)b=d(b);return b}if(!a._obj(m))throw l.type("source");
