...
return c}(),v=function(){function c(e,d){if(!arguments.length)throw a("Missing a val");if(!b.un.bool(d))throw a.type("deep");return b._obj(e)?b.func(e)?m(e,d):b._arr(e)?h(e,d):b.regex(e)?l(e):g(e,d):e}function g(b,a){return a?n({},b):x({},b)}function h(b,a){var f;f=Array(b.length);return a?n(f,b):x(f,b)}function l(a,d){var k,c;k=p(a.source);var g;c="";for(g in f)q(f,g)&&a[g]&&(c+=f[g]);c=b.undefined(d)?c:B(c,"g")?d?c:c.replace("g",""):d?c+"g":c;return c?new RegExp(k,c):new RegExp(k)}function m(b,
...
b&&e.push(f);return e}function m(a,e){var f,c;e=b.regex(e)?e:String(e);f=[];for(c in a)q(a,c)&&y(c,e)&&f.push(a[c]);return f}function n(a){var b,e;b=a.length;a=Array(b);for(e=-1;++e<b;)a[e]=e;return a}function p(a,b){var e,f,c;f=a.length;e=[];for(c=-1;++c<f;)a[c]===b&&e.push(c);return e}function f(a,e){var f;if(y(a,e)){if(b.regex(e)){var c,g;f=v.regex(e,!0);c=[];for(g=f.exec(a);g;)c.push(g.index),g=f.exec(a)}else for(f=String(e),c=[],g=a.indexOf(f);-1!==g;)c.push(g),g=a.indexOf(f,++g);f=c}else f=
[];return f}function a(a,e){var f;if(y(a,e)){if(b.regex(e)){var c,g;f=v.regex(e,!0);c=[];for(g=f.exec(a);g;)c.push(g[0]),g=f.exec(a)}else for(f=String(e),c=[],g=a.indexOf(f);-1!==g;)c.push(f),g=a.indexOf(f,++g);f=c}else f=[];return f}c.keys=function(a,f){if(!b._obj(a))throw e.type("source","keys");return 2>arguments.length?g(a):b.regex(f)?h(a,f):l(a,f)};c.keys.byKey=function(a,f){if(!b._obj(a))throw e.type("source","keys.byKey");if(2>arguments.length)throw e("No pattern defined","keys.byKey");return h(a,
...
c.num=c.number;c["boolean"]=function(b){if(!arguments.length)throw g("Missing a val","boolean");return!!b};c.bool=c["boolean"];c.array=function(c,l){if(!arguments.length)throw g("Missing a val","array");if(b.num(c))return Array(c);if(!b.str(c))throw g.type("val","array");if(b.undefined(l))return z(c);l=b.regex(l)?l:String(l);return c.split(l)};c.arr=c.array;c.regexp=function(c,l){if(!arguments.length)throw g("Missing a source","regexp");if(!b.str(c))throw g.type("source","regexp");if(!b.un.str(l))throw g.type("flags",
