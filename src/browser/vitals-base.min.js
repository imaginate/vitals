/* vitals-base.js v4.0.0 (https://github.com/imaginate/vitals)
...
(function(u,w){function A(b,q){return"object"===b||!q&&"function"===b}function x(b,q){return(b=b&&q&&b.nodeType?!1:b)&&!q&&b.Object!==Object?!1:!!b}function y(b){b.vitals=w;b.Vitals=w}var r=A(typeof exports)&&x(exports,!0),D=A(typeof module)&&x(module,!0),z=A(typeof global,!0)&&x(global),q=A(typeof window)&&x(window),E=A(typeof self)&&x(self),B=A(typeof u)&&x(u);u=r&&D&&z?global:q&&window!==(u&&u.window)?window:E?self:B?u:Function("return this")();q&&y(window);E&&y(self);y(u);r&&D&&(module.exports===
...
return c}(),v=function(){function c(e,d){if(!arguments.length)throw a("Missing a val");if(!b.un.bool(d))throw a.type("deep");return b._obj(e)?b.func(e)?m(e,d):b._arr(e)?h(e,d):b.regex(e)?l(e):g(e,d):e}function g(b,a){return a?n({},b):x({},b)}function h(b,a){var f;f=Array(b.length);return a?n(f,b):x(f,b)}function l(a,d){var k,c;k=p(a.source);var h;c="";for(h in f)q(f,h)&&a[h]&&(c+=f[h]);c=b.undefined(d)?c:B(c,"g")?d?c:c.replace("g",""):d?c+"g":c;return c?new RegExp(k,c):new RegExp(k)}function m(b,
a){var f;f=function(){return b.apply(null,arguments)};return a?n(f,b):x(f,b)}function n(b,a){for(var f in a)q(a,f)&&(b[f]=c(a[f],!0));return b}c.object=function(e,d){if(!b.obj(e))throw a.type("obj","object");if(!b.un.bool(d))throw a.type("deep","object");return g(e,d)};c.obj=c.object;c.array=function(e,d){if(!b.obj(e))throw a.type("obj","array");if(!b.num(e.length))throw a.type("obj.length","array");if(!b.un.bool(d))throw a.type("deep","array");return h(e,d)};c.arr=c.array;c.args=c.array;c.regexp=
function(e,d){if(!b.regex(e))throw a.type("regex","regexp");if(!b.un.bool(d))throw a.type("forceGlobal","regexp");return l(e,d)};c.re=c.regexp;c.regex=c.regexp;c.func=function(e,d){if(!b.func(e))throw a.type("func","function");if(!b.un.bool(d))throw a.type("deep","function");return m(e,d)};try{c.fn=c.func,c["function"]=c.func}catch(e){}var p=function(){var b="\\n"!==/\n/.source?/\\/g:null;return b?function(a){return a.replace(b,"\\\\")}:function(b){return b}}(),f=x({ignoreCase:"i",multiline:"m",global:"g"},
"sticky"in RegExp.prototype?{sticky:"y"}:null),a=w("copy");return c}(),J=function(){function c(a,d,e){if(2>arguments.length)throw t("No val defined");if(b.str(a))return d=2<arguments.length?r(arguments,1):d,b.arr(d)?p(a,d):n(a,d);if(!b._obj(a))throw t.type("source");a=b.args(a)?r(a):a;if(b.func(d)){if(!b.nil.un.obj(e))throw t.type("thisArg");return b.arr(a)?u(a,d,e):H(a,d,e)}d=2<arguments.length?r(arguments,1):d;return b.arr(d)?h(a,d):g(a,d)}function g(e,c){return b.arr(e)?b.num(c)?d(e,c):F(e,c):
C("!str|regex",c)?f(e,c):a(e,c)}function h(a,d){var c;if(b.arr(a))c=C("nums",d)?k(a,d):G(a,d);else if(C("!str|regex",d[0])){c=a;var h,g,p;h=b.regex(d[0]);g=d.length;for(p=-1;++p<g;)c=f(c,d[p],h)}else c=e(a,d);return c}function l(a,d,e){var f;f=a.length;d=0>d?f+d:d;if(d>=f)return a;if(b.undefined(e)){if(0>d)return a;a.splice(d,1);return a}d=0>d?0:d;e=e>f?f:0>e?f+e:e;if(d>=e)return a;a.splice(d,e-d);return a}function m(d,e){return b.arr(d)?F(d,e):a(d,e)}function n(a,d){b.regex(d)||(d=String(d),d=E(d),
d=new RegExp(d,"g"));return a.replace(d,"")}function p(b,a){var d,e;d=a.length;for(e=-1;++e<d;)b=n(b,a[e]);return b}function f(a,d,e){e=b.undefined(e)?b.regex(d):e;if(!e)return q(a,d)&&delete a[d],a;e=d;for(d in a)q(a,d)&&y(d,e)&&delete a[d];return a}function a(b,a){for(var d in b)q(b,d)&&b[d]===a&&delete b[d];return b}function e(b,d){var e,f;e=d.length;for(f=-1;++f<e;)b=a(b,d[f]);return b}function d(b,a){var d;d=b.length;a=0>a?d+a:a;if(0>a||a>=d)return b;b.splice(a,1);return b}function k(b,a){var e,
f,c,k;if(!b.length||!a.length)return b;if(2>a.length)return d(b,a[0]);e=z(a,b.length);for(k=e.first.length;k--;)f=e.first[k],c=e.last[k]-f+1,b.splice(f,c);return b}function F(b,a){var d;for(d=b.length;d--;)b[d]===a&&b.splice(d,1);return b}function G(b,a){var d,e,f,c;e=a.length;for(c=b.length;c--;)for(d=b[c],f=e;f--;)if(a[f]===d){b.splice(c,1);break}return b}function H(a,d,e){var f;d=b.undefined(e)?d:x(d,e);e=2<d.length?v(a):a;switch(d.length){case 0:for(f in e)q(e,f)&&!d()&&delete a[f];break;case 1:for(f in e)q(e,
f)&&!d(e[f])&&delete a[f];break;case 2:for(f in e)q(e,f)&&!d(e[f],f)&&delete a[f];break;default:for(f in e)q(e,f)&&!d(e[f],f,e)&&delete a[f]}return a}function u(a,d,e){var f;d=b.undefined(e)?d:x(d,e);e=2<d.length?v.arr(a):a;f=e.length;switch(d.length){case 0:for(;f--;)d()||a.splice(f,1);break;case 1:for(;f--;)d(e[f])||a.splice(f,1);break;case 2:for(;f--;)d(e[f],f)||a.splice(f,1);break;default:for(;f--;)d(e[f],f,e)||a.splice(f,1)}return a}function x(b,a){switch(b.length){case 0:return function(){return b.call(a)};
case 1:return function(d){return b.call(a,d)};case 2:return function(d,e){return b.call(a,d,e)}}return function(d,e,f){return b.call(a,d,e,f)}}c.property=function(a,d,e){if(!b._obj(a))throw t.type("source","property");if(2>arguments.length)throw t("No val defined","property");a=b.args(a)?r(a):a;if(b.func(d)){if(!b.nil.un.obj(e))throw t.type("thisArg","property");return b.arr(a)?u(a,d,e):H(a,d,e)}return g(a,d)};c.prop=c.property;c.key=function(a,d){if(!b._obj(a))throw t.type("source","key");if(2>arguments.length)throw t("No key defined",
"key");delete a[d];return a};c.index=function(a,d,e){if(!b._obj(a))throw t.type("source","index");if(!b.num(a.length))throw t.type("source.length","index");if(!b.num(d))throw t.type("index","index");if(!b.un.num(e))throw t.type("toIndex","index");a=b.arr(a)?a:r(a);return l(a,d,e)};c.i=c.index;c.type=function(a,d){if(!b._obj(a))throw t.type("source","type");if(!b.str(d))throw t.type("type","type");try{C(d,"_")}catch(e){throw new RangeError("Invalid type value for vitals.cut.type call. See error from are: "+
...
h;)k=a(f[g],c),-1!==k&&b(k,0,e.length);return{first:d,last:e}}}(),t=w("cut");return c}(),K=function(){function c(c,f,a){if(!b.func(f))throw n.type("iteratee");if(!b.nil.un.obj(a))throw n.type("thisArg");if(b.num(c))return l(c,f,a);b.str(c)&&(c=z(c));if(!b._obj(c))throw n.type("source");return b._arr(c)?h(c,f,a):g(c,f,a)}function g(c,f,a){var e;c=2<f.length?v(c):c;f=b.undefined(a)?f:m(f,a);switch(f.length){case 0:for(e in c)q(c,e)&&f();break;case 1:for(e in c)q(c,e)&&f(c[e]);break;case 2:for(e in c)q(c,
...
return l(c,a,e,d)}if(2<arguments.length){f=b.str(f)?z(f):f;if(!b.arr(f))throw n.type("keys");return h(c,f,a)}return g(c,f)}function g(b,f){for(var a in b)q(b,a)&&(b[a]=f);return b}function h(b,f,a){var e,d;e=f.length;for(d=-1;++d<e;)b[f[d]]=a;return b}function l(b,f,a,e){var d;d=b.length;a=a||0;a=0>a?d+a:a;a=0>a?0:a;e=e||d;e=e>d?d:0>e?d+e:e;if(a>=e)return b;for(--a;++a<e;)b[a]=f;return b}function m(b,f){var a;b=0>b?0:b;if(!b)return"";f=String(f);for(a="";b--;)a+=f;return a}c.object=function(c,f,a){if(!b._obj(c))throw n.type("obj",
"object");if(2>arguments.length)throw n("No val defined","object");if(2<arguments.length){f=b.str(f)?z(f):f;if(!b.arr(f))throw n.type("keys","object");return h(c,f,a)}return g(c,f)};c.obj=c.object;c.array=function(c,f,a,e){c=b.num(c)?Array(c):c;if(2>arguments.length)throw n("No val defined","array");if(!b.arr(c))throw n.type("arr","array");if(!b.un.num(a))throw n.type("start","array");if(!b.un.num(e))throw n.type("end","array");return l(c,f,a,e)};c.arr=c.array;c.string=function(c,f){if(!b.num(c))throw n.type("count",
...
return p(a,e)}if(!b._obj(a))throw f.type("dest","value");a=b.args(a)?r(a):a;if(3>arguments.length){var d;b.arr(a)?(d=a,d.push(e)):(d=a,d[e]=u);return d}e=r(arguments,1);if(b.arr(a)){d=a;var c=e,h,g;h=c.length;for(g=-1;++g<h;)d.push(c[g])}else{d=a;var c=e,l;g=c.length;for(l=-1;++l<g;)h=c[l],d[h]=u}return d};c.val=c.value;c.value.start=function(a,e){if(2>arguments.length)throw f("No val defined","value.start");if(b.str(a)){if(3>arguments.length)return e+a;e=r(arguments,1);var d=a,c,h;c=e.length;for(h=
-1;++h<c;)d=e[h]+d;return d}if(!b._obj(a))throw f.type("dest","value.start");a=b.args(a)?r(a):a;if(3>arguments.length)return b.arr(a)?(d=a,d.unshift(e)):d=l(a,e),d;e=r(arguments,1);if(b.arr(a)){d=a;c=e;var g;h=c.length;for(g=-1;++g<h;)d.unshift(c[g])}else for(d=a,c=e,h=c.length,g=-1;++g<h;)d=l(d,c[g]);return d};c.val.start=c.value.start;c.value.top=c.value.start;c.val.top=c.value.start;c.object=function(a,e){if(!b._obj(a))throw f.type("dest","object");if(2>arguments.length)throw f("No val defined",
...
c.string;var f=w("fuse");return c}(),N=function(){function c(d,c){if(b.str(d)){if(2>arguments.length)throw e("No val defined");return b.regex(c)?a(d,c):f(d,c)}if(!b._obj(d))throw e.type("source");return 2>arguments.length?b._arr(d)?n(d):g(d):b._arr(d)?p(d,c):b.regex(c)?m(d,c):l(d,c)}function g(a){var b,e;b=[];for(e in a)q(a,e)&&b.push(e);return b}function h(a,e){var f,c;e=b.regex(e)?e:String(e);f=[];for(c in a)q(a,c)&&y(c,e)&&f.push(c);return f}function l(a,b){var e,f;e=[];for(f in a)q(a,f)&&a[f]===
b&&e.push(f);return e}function m(a,e){var f,c;e=b.regex(e)?e:String(e);f=[];for(c in a)q(a,c)&&y(c,e)&&f.push(a[c]);return f}function n(a){var b,e;b=a.length;a=Array(b);for(e=-1;++e<b;)a[e]=e;return a}function p(a,b){var e,f,c;f=a.length;e=[];for(c=-1;++c<f;)a[c]===b&&e.push(c);return e}function f(a,e){var f;if(y(a,e)){if(b.regex(e)){var c,h;f=v.regex(e,!0);c=[];for(h=f.exec(a);h;)c.push(h.index),h=f.exec(a)}else for(f=String(e),c=[],h=a.indexOf(f);-1!==h;)c.push(h),h=a.indexOf(f,++h);f=c}else f=
[];return f}function a(a,e){var f;if(y(a,e)){if(b.regex(e)){var c,h;f=v.regex(e,!0);c=[];for(h=f.exec(a);h;)c.push(h[0]),h=f.exec(a)}else for(f=String(e),c=[],h=a.indexOf(f);-1!==h;)c.push(f),h=a.indexOf(f,++h);f=c}else f=[];return f}c.keys=function(a,f){if(!b._obj(a))throw e.type("source","keys");return 2>arguments.length?g(a):b.regex(f)?h(a,f):l(a,f)};c.keys.byKey=function(a,f){if(!b._obj(a))throw e.type("source","keys.byKey");if(2>arguments.length)throw e("No pattern defined","keys.byKey");return h(a,
...
function h(c,a,e){var d,h;c=2<a.length?v.arr(c):c;a=b.undefined(e)?a:m(a,e);d=c.length;e=Array(d);h=-1;switch(a.length){case 0:for(;++h<d;)e[h]=a();break;case 1:for(;++h<d;)e[h]=a(c[h]);break;case 2:for(;++h<d;)e[h]=a(c[h],h);break;default:for(;++h<d;)e[h]=a(c[h],h,c)}return e}function l(c,a,e,d){if(!c)return c;b.regex(a)||(a=String(a),a=E(a),a=new RegExp(a,"g"));e=b.func(e)?b.undefined(d)?e:n(e,d):String(e);return c.replace(a,e)}function m(b,a){switch(b.length){case 0:return function(){return b.call(a)};
case 1:return function(e){return b.call(a,e)};case 2:return function(e,d){return b.call(a,e,d)}}return function(e,d,c){return b.call(a,e,d,c)}}function n(b,a){switch(b.length){case 0:return function(){return b.call(a)};case 1:return function(e){return b.call(a,e)};case 2:return function(e,d){return b.call(a,e,d)};case 3:return function(e,d,c){return b.call(a,e,d,c)};case 4:return function(e,d,c,h){return b.call(a,e,d,c,h)};case 5:return function(e,d,c,h,g){return b.call(a,e,d,c,h,g)}}return function(){return b.apply(a,
arguments)}}c.object=function(c,a,e){if(!b._obj(c))throw p.type("source","object");if(!b.func(a))throw p.type("iteratee","object");if(!b.nil.un.obj(e))throw p.type("thisArg","object");return g(c,a,e)};c.obj=c.object;c.array=function(c,a,e){b.str(c)&&(c=z(c));if(!b._obj(c))throw p.type("source","array");if(!b.num(c.length))throw p.type("source.length","array");if(!b.func(a))throw p.type("iteratee","array");if(!b.nil.un.obj(e))throw p.type("thisArg","array");return h(c,a,e)};c.arr=c.array;c.string=
...
l,m){if(!b.str(c))throw g.type("str","string");if(!b.un.num(l))throw g.type("start","string");if(!b.un.num(m))throw g.type("end","string");return D(c,l,m)};c.str=c.string;var g=w("slice");return c}(),T=function(){var c={string:function(c,l){if(!arguments.length)throw g("Missing a val","string");if(!b.un.str(l))throw g.type("joiner","string");return b.arr(c)&&b.str(l)?c.join(l):String(c)}};c.str=c.string;c.number=function(c){if(!arguments.length)throw g("Missing a val","number");if(b.num(c))return c;
if(b.nil.bool(c))return c?1:0;if(!b.str(c))throw g.type("val","number");c=Number(c);if(b.nan(c))throw g.range("val","see github.com/imaginate/vitals/wiki/vitals.to#tonumber","number");return c};c.num=c.number;c["boolean"]=function(b){if(!arguments.length)throw g("Missing a val","boolean");return!!b};c.bool=c["boolean"];c.array=function(c,l){if(!arguments.length)throw g("Missing a val","array");if(b.num(c))return Array(c);if(!b.str(c))throw g.type("val","array");if(b.undefined(l))return z(c);l=b.regex(l)?
l:String(l);return c.split(l)};c.arr=c.array;c.regexp=function(c,l){if(!arguments.length)throw g("Missing a source","regexp");if(!b.str(c))throw g.type("source","regexp");if(!b.un.str(l))throw g.type("flags","regexp");return l?new RegExp(c,l):new RegExp(c)};c.regex=c.regexp;c.re=c.regexp;c.upperCase=function(c){if(!arguments.length)throw g("Missing a str","upperCase");if(!b.str(c))throw g.type("source","upperCase");return c.toUpperCase()};c.upper=c.upperCase;c.lowerCase=function(c){if(!arguments.length)throw g("Missing a str",
"lowerCase");if(!b.str(c))throw g.type("source","lowerCase");return c.toLowerCase()};c.lower=c.lowerCase;var g=w("to");return c}(),U=function(){function c(c,a,e,d){if(2>arguments.length)throw p("No end or iteratee defined");if(2===arguments.length){e=a;if(!b.func(e))throw p.type("iteratee");return g(c,e)}if(3===arguments.length&&b.func(a)&&b.nil.obj(e))return d=e,g(c,a,d);if(!b.func(e))throw p.type("iteratee");if(!b.nil.un.obj(d))throw p.type("thisArg");if(b.num(a))return m(c,a,e,d);b.str(a)&&(a=
z(a));if(!b._obj(a))throw p.type("source");return b._arr(a)?l(c,a,e,d):h(c,a,e,d)}function g(c,a,e){a=b.undefined(e)?a:n(a,e);if(a.length)for(e=0;a(e++)!==c;);else for(;a()!==c;);return!0}function h(c,a,e,d){var g;a=2<e.length?v(a):a;e=b.undefined(d)?e:n(e,d);switch(e.length){case 0:for(g in a)if(q(a,g)&&e()===c)return!0;break;case 1:for(g in a)if(q(a,g)&&e(a[g])===c)return!0;break;case 2:for(g in a)if(q(a,g)&&e(a[g],g)===c)return!0;break;default:for(g in a)if(q(a,g)&&e(a[g],g,a)===c)return!0}return!1}
function l(c,a,e,d){var g;a=2<e.length?v.arr(a):a;e=b.undefined(d)?e:n(e,d);d=a.length;g=-1;switch(e.length){case 0:for(;++g<d;)if(e()===c)return!0;break;case 1:for(;++g<d;)if(e(a[g])===c)return!0;break;case 2:for(;++g<d;)if(e(a[g],g)===c)return!0;break;default:for(;++g<d;)if(e(a[g],g,a)===c)return!0}return!1}function m(c,a,e,d){e=b.undefined(d)?e:n(e,d);if(e.length)for(d=0;a--;){if(e(d++)===c)return!0}else for(;a--;)if(e()===c)return!0;return!1}function n(b,a){switch(b.length){case 0:return function(){return b.call(a)};
case 1:return function(c){return b.call(a,c)};case 2:return function(c,d){return b.call(a,c,d)}}return function(c,d,g){return b.call(a,c,d,g)}}c.object=function(c,a,e,d){if(!b._obj(a))throw p.type("obj","object");if(!b.func(e))throw p.type("iteratee","object");if(!b.nil.un.obj(d))throw p.type("thisArg","object");return h(c,a,e,d)};c.obj=c.object;c.array=function(c,a,e,d){b.str(a)&&(a=z(a));if(!b._obj(a))throw p.type("source","array");if(!b.num(a.length))throw p.type("source.length","array");if(!b.func(e))throw p.type("iteratee",
"array");if(!b.nil.un.obj(d))throw p.type("thisArg","array");return l(c,a,e,d)};c.arr=c.array;c.cycle=function(c,a,e,d){if(!b.num(a))throw p.type("count","cycle");if(!b.func(e))throw p.type("action","cycle");if(!b.nil.un.obj(d))throw p.type("thisArg","cycle");return m(c,a,e,d)};c.time=c.cycle;var p=w("until");return c}();return{copy:v,cut:J,each:K,fill:L,fuse:M,get:N,has:O,is:C,remap:P,roll:Q,same:R,slice:S,to:T,until:U}}());
