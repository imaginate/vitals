...
g;)l=a(f[h],c),-1!==l&&b(l,0,e.length);return{first:d,last:e}}}(),x=y("cut");return c}(),N=function(){function c(c,f,b){if(!a.func(f))throw m.type("iteratee");if(!a.nil.un.obj(b))throw m.type("thisArg");if(a.num(c))return k(c,f,b);a.str(c)&&(c=v(c));if(!a._obj(c))throw m.type("source");return a._arr(c)?h(c,f,b):g(c,f,b)}function g(c,f,b){var e;c=2<f.length?t(c):c;f=a.undefined(b)?f:n(f,b);switch(f.length){case 0:for(e in c)q(c,e)&&f();break;case 1:for(e in c)q(c,e)&&f(c[e]);break;case 2:for(e in c)q(c,
...
return k(c,b,e,d)}if(2<arguments.length){f=a.str(f)?v(f):f;if(!a.arr(f))throw m.type("keys");return h(c,f,b)}return g(c,f)}function g(a,f){for(var b in a)q(a,b)&&(a[b]=f);return a}function h(a,f,b){var e,d;e=f.length;for(d=-1;++d<e;)a[f[d]]=b;return a}function k(a,f,b,e){var d;d=a.length;b=b||0;b=0>b?d+b:b;b=0>b?0:b;e=e||d;e=e>d?d:0>e?d+e:e;if(b>=e)return a;for(--b;++b<e;)a[b]=f;return a}function n(a,f){var b;a=0>a?0:a;if(!a)return"";f=String(f);for(b="";a--;)b+=f;return b}c.object=function(c,f,b){if(!a._obj(c))throw m.type("obj",
...
"string");if(2>arguments.length)throw m("No val defined","string");return n(c,f)};c.str=c.string;var m=y("fill");return c}(),P=function(){function c(b,e){if(2>arguments.length)throw f("No val defined");if(a.str(b))return e=2<arguments.length?w(arguments,1):e,a.arr(e)?p(b,e):b+e;if(!a._obj(b))throw f.type("dest");b=a.args(b)?w(b):b;if(a.arr(b))return 2<arguments.length?(e=w(arguments,1),m(b,e)):n(b,e);e=2<arguments.length?w(arguments,1):e;return a.arr(e)?h(b,e):g(b,e)}function g(b,e){if(a._obj(e))return D(b,
e);a.nil(e)||(b[e]=r);return b}function h(a,e){var d,f;d=e.length;for(f=-1;++f<d;)a=g(a,e[f]);return a}function k(a,e){q(a,e)||(a[e]=r);return a}function n(b,e){if(a.arr(e))return b.concat(e);a.nil(e)||b.push(e);return b}function m(a,e){var d,f;d=e.length;for(f=-1;++f<d;)a=n(a,e[f]);return a}function p(a,e){var d,f;d=e.length;for(f=-1;++f<d;)a+=e[f];return a}c.value=function(b,e){if(2>arguments.length)throw f("No val defined","value");if(a.str(b)){if(3>arguments.length)return b+e;e=w(arguments,1);
...
"object");e=2<arguments.length?w(arguments,1):e;return a.arr(e)?h(b,e):g(b,e)};c.obj=c.object;c.array=function(b,e){if(!a._arr(b))throw f.type("dest","array");if(2>arguments.length)throw f("No val defined","array");b=a.args(b)?w(b):b;return 2<arguments.length?(e=w(arguments,1),m(b,e)):n(b,e)};c.arr=c.array;c.string=function(b,e){if(!a.str(b))throw f.type("dest","string");if(2>arguments.length)throw f("No val defined","string");e=2<arguments.length?w(arguments,1):e;return a.arr(e)?p(b,e):b+e};c.str=
...
arguments.length)throw g("No val defined","substring");return F(c,k)};c.substr=c.substring;c.enumerable=function(c,k){if(2>arguments.length)throw g("No key defined","enumerable");if(a.nil(c))return!1;if(!a._obj(c))throw g.type("source","enumerable");return L(c,k)};try{c["enum"]=c.enumerable}catch(h){}var g=y("has");return c}(),S=function(){function c(c,b,e,d){if(a.str(c)){if(2>arguments.length)throw p("No iteratee defined");if(3>arguments.length)throw p("No replacement defined");if(!a.nil.un.obj(d))throw p.type("thisArg");
...
d)&&(l?e-=f():(e=b[d],l=!0));break;case 1:for(d in b)q(b,d)&&(l?e-=f(b[d]):(e=b[d],l=!0));break;case 2:for(d in b)q(b,d)&&(l?e-=f(b[d],d):(e=b[d],l=!0));break;default:for(d in b)q(b,d)&&(l?e-=f(b[d],d,b):(e=b[d],l=!0))}}b=e}return b};var h=y("roll");return c}(),U=function(){function a(c,k){if(2>arguments.length)throw g("Missing a val");return c===k}a.loose=function(a,c){if(2>arguments.length)throw g("Missing a val","loose");return a==c};a.ish=a.loose;var g=y("same");return a}(),V=function(){function c(c,
k,n){if(!a.un.num(k))throw g.type("start");if(!a.un.num(n))throw g.type("end");if(a.nil(c))return null;if(a.str(c))return E(c,k,n);if(!a._obj(c))throw g.type("source");if(!a.num(c.length))throw g.type("source.length");return w(c,k,n)}c.array=function(c,k,n){if(!a._obj(c))throw g.type("source","array");if(!a.num(c.length))throw g.type("source.length","array");if(!a.un.num(k))throw g.type("start","array");if(!a.un.num(n))throw g.type("end","array");return w(c,k,n)};c.arr=c.array;c.string=function(c,
k,n){if(!a.str(c))throw g.type("str","string");if(!a.un.num(k))throw g.type("start","string");if(!a.un.num(n))throw g.type("end","string");return E(c,k,n)};c.str=c.string;var g=y("slice");return c}(),W=function(){var c={string:function(c,k){if(!arguments.length)throw g("Missing a val","string");if(!a.un.str(k))throw g.type("joiner","string");return a.arr(c)&&a.str(k)?c.join(k):String(c)}};c.str=c.string;c.number=function(c){if(!arguments.length)throw g("Missing a val","number");if(a.num(c))return c;
if(a.nil.bool(c))return c?1:0;if(!a.str(c))throw g.type("val","number");c=Number(c);if(a.nan(c))throw g.range("val","see github.com/imaginate/vitals/wiki/vitals.to#tonumber","number");return c};c.num=c.number;c["boolean"]=function(a){if(!arguments.length)throw g("Missing a val","boolean");return!!a};c.bool=c["boolean"];c.array=function(c,k){if(!arguments.length)throw g("Missing a val","array");if(a.num(c))return Array(c);if(!a.str(c))throw g.type("val","array");if(a.undefined(k))return v(c);k=a.regex(k)?
...
c))throw u.type("props","config");if(!t(b,c))throw u("A given prop was not defined in the obj","config");return F(b,c)};c.property=function(b,c,g,h,k,n){var m;if(!a.obj(b))throw u.type("obj","property");if(!a.str(c))throw u.type("key","property");m=arguments.length;if(3>m)throw u("No val or descriptor defined","property");if(2<m&&6>m){var t=g,v=h,y=k,A=n;switch(m){case 4:a.str(v)?(y=v,v=r):a.func(v)&&(A=v,v=r);break;case 5:a.func(y)&&(A=y,y=r,a.str(v)&&(y=v,v=r))}a.obj(t)&&e(t)&&(v=t,t=v.value);m=
[t,v,y,A];g=m[0];h=m[1];k=m[2];n=m[3]}if(!z("!obj=",h))throw u.type("descriptor","property");if(!z("str=",k))throw u.type("strongType","property");if(!z("func=",n))throw u.type("setter","property");if(k&&!z(k+"=",g))throw u("The val param is not a valid strongType","property");if(h&&(k||n)&&q(h,"writable"))throw u("A data descriptor may not be used with a strongType/setter","property");m=g;v=k;y=n;t=h||null;t=l(t,!!v||!!y);t=(v=w(v))||y?f(m,t,v,y):d(t)?C(t):p(m,t);return x(b,c,t)};c.prop=c.property;
c.property.config=function(b,c,d){if(!a.obj(b))throw u.type("obj","property.config");if(!a.str(c))throw u.type("key","property.config");if(!a.obj(d))throw u.type("descriptor","property.config");if(!q(b,c))throw u("The key was not defined in the obj","property.config");return x(b,c,d)};c.prop.config=c.property.config;c.properties=function(b,c,d,e,f,n){var l,m;if(!a.obj(b))throw u.type("obj","properties");a.str(c)&&(c=v(c));if(!a.obj(c))throw u.type("props","properties");l=a.arr(c);m=arguments.length;
if(l&&3>m)throw u("No val defined","properties");!l&&2<m&&(n=f,f=e,e=d,d=r,++m);if(4===m||5===m)m=g(m,e,f,n),e=m[0],f=m[1],n=m[2];if(!z("!obj=",e))throw u.type("descriptor","properties");if(!z("str=",f))throw u.type("strongType","properties");if(!z("func=",n))throw u.type("setter","properties");if(f){if(l&&!z(f+"=",d))throw u("The val param is not a valid strongType","properties");if(!l&&!h(f,c))throw u("A props value was not a valid strongType","properties");}return k(b,c,d,e,f,n)};c.props=c.properties;
c.properties.config=function(b,c,d){if(!a.obj(b))throw u.type("obj","properties.config");a.str(c)&&(c=v(c));if(!a.obj(c))throw u.type("props","properties.config");if(a.arr(c)){if(!a.obj(d))throw u.type("descriptor","properties.config");c=m(c,d)}else if(!z("objMap",c))throw u.type("props","properties.config");if(!t(b,c))throw u("A given prop was not defined in the obj","properties.config");return F(b,c)};c.props.config=c.properties.config;var B={writable:!0,enumerable:!0,configurable:!0},A={enumerable:!0,
configurable:!0},E={get:!0,set:!0,value:!0,writable:!0,enumerable:!0,configurable:!0},G=!!Object.defineProperties&&function(){var a,b,c;b={};a={enumerable:!1,value:b};try{for(c in Object.defineProperty(b,"prop",a),b)if("prop"===c)return!1}catch(d){return!1}return b.prop===b}(),x=G?Object.defineProperty:function(a,b,c){a[b]=q(c,"get")?c.get():c.value;return a},F=G?Object.defineProperties:function(a,b){var c,d;for(d in b)q(b,d)&&(c=b[d],a[d]=q(c,"get")?c.get():c.value);return a},u=y("amend");return c}(),
Y=function(){function c(c,g,p,f,b,e){var d;if(!a.nil.obj(c))throw k.type("proto");return 1<arguments.length?(d=w(arguments),d[0]=h(c),J.apply(null,d)):h(c)}function g(){}c.object=function(c,g,p,f,b,e){var d;if(!a.nil.obj(c))throw k.type("proto","object");return 1<arguments.length?(d=w(arguments),d[0]=h(c),J.apply(null,d)):h(c)};c.obj=c.object;var h=Object.create||function(a){g.prototype=a;a=new g;g.prototype=null;return a},k=y("create");return c}(),Z=function(){function c(c,m){if(a.nil(c))return null;
if(!a._obj(c))throw k.type("obj");if(!a.un.bool(m))throw k.type("deep");return m?g(c):h(c)}function g(c,k){for(var p in c)q(c,p)&&a._obj(c[p])&&g(c[p]);return h(c)}c.object=function(c,m){if(a.nil(c))return null;if(!a._obj(c))throw k.type("obj","object");if(!a.un.bool(m))throw k.type("deep","object");return m?g(c):h(c)};c.obj=c.object;var h=function(){if(!Object.freeze)return function(a){return a};try{return Object.freeze(function(){}),Object.freeze}catch(c){return function(c){return a.func(c)?c:Object.freeze(c)}}}(),
k=y("freeze");return c}(),aa=function(){function c(c,m){if(a.nil(c))return null;if(!a._obj(c))throw k.type("obj");if(!a.un.bool(m))throw k.type("deep");return m?h(c):g(c)}c.object=function(c,m){if(a.nil(c))return null;if(!a._obj(c))throw k.type("obj","seal");if(!a.un.bool(m))throw k.type("deep","seal");return m?h(c):g(c)};c.obj=c.object;var g=Object.seal?Object.seal:function(a){return a},h=Object.seal?function m(c){for(var f in c)q(c,f)&&a._obj(c[f])&&m(c[f]);return g(c)}:function(a){return a},k=
y("seal");return c}();return{amend:J,copy:t,create:Y,cut:M,each:N,fill:O,freeze:Z,fuse:P,get:Q,has:R,is:z,remap:S,roll:T,same:U,seal:aa,slice:V,to:W,until:X}}());
