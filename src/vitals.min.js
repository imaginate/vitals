...
/* Vitals.js (v1.0.7) (learn@algorithmiv.com)
 * Author: Adam Smith (adamsmith@algorithmiv.com)
 * Copyright (c) 2015 Adam A Smith (github.com/imaginate)
 * The Apache License (algorithmiv.com/vitals/license) */
(function(b,n){b.Vitals=b.Vitals||n;b.Vx=Vitals})(window,function(b,n,A){b={};var x={checkArgsErrorMsg:"A method call received an invalid parameter type.",getElemByClassRoot:n,getElemsByClassRoot:n,getElemByTagRoot:n,getElemsByTagRoot:n,types:{checkArgsErrorMsg:"string|function",getElemByClassRoot:"!(Document|Element)",getElemsByClassRoot:"!(Document|Element)",getElemByTagRoot:"!(Document|Element)",getElemsByTagRoot:"!(Document|Element)"}};Object.freeze(x);Object.freeze(x.types);var w={checkArgsErrorMsg:x.checkArgsErrorMsg,
getElemByClassRoot:x.getElemByClassRoot,getElemsByClassRoot:x.getElemsByClassRoot,getElemByTagRoot:x.getElemByTagRoot,getElemsByTagRoot:x.getElemsByTagRoot},y={};y.freezeRegExpBug=function(){var g,f;g=/0/g;Object.freeze(g);f=!0;try{"T00 many zer0s... replace them.".replace(g,"o")}catch(a){f=!1}return!f}();Object.freeze(y);var k={allDataTypes:/^any$|^string$|^number$|^boolean$|^object$|^array$|^function$|^elem$|^element$|^undefined$|^null$|^document$|^strings$|^numbers$|^booleans$|^objects$|^arrays$|^elems$|^elements$|^functions$|^stringmap$|^numbermap$|^booleanmap$|^objectmap$|^arraymap$|^functionmap$|^elemmap$|^elementmap$/,
exceptLowerAlphaAndPipe:/[^a-z\|]/g};Object.freeze(k);b.checkType=function(g,f){var a=/^string$|^number$|^boolean$|^function$|^undefined$/,c=/^string$|^number$|^boolean$|^object$|^function$|^undefined$/,d=/^elem$|^element$|^document$/,b=/^array$|^strings$|^numbers$|^booleans$|^objects$|^arrays$|^elems$|^elements$|^functions$/,p=/^stringmap$|^numbermap$|^booleanmap$|^objectmap$|^arraymap$|^functionmap$|^elemmap$|^elementmap$/,n=/\!/,q=/\?/,w=/\=/,x=/\*/,k=function(a,c){return null===a?!1:typeof a===
c},y=function(a,c){return a&&k(a,"object")&&a.nodeType?a.nodeType==={elem:1,element:1,document:9}[c]:!1};return function(m,e,t){var u,z,r,h;if(!k(e,"string"))throw new TypeError("A Vitals.checkType call received a non-string type param.");if(x.test(e)){if(1<e.length)throw m="A Vitals.checkType call received an invalid type string. When using an asterisk, '*', no other values should be given as the asterisk guarantees the check will ",m+="pass.",Error(m);return!0}if(u=m===A&&w.test(e))h=!0;else{h=
e;var v;v=(r=null===m)?n.test(h):!0;r&&q.test(h)&&(v=!v);h=v}r=u||!h||n.test(e)?!1:q.test(e);u=u||r&&h;if(!t||!u)if(e=e.toLowerCase(),e=e.replace(f,""),z=e.split("|"),!t)for(e=z,v=!0,t=e.length;v&&t--;)if(v=g.test(e[t]),!v)throw m=void 0,m="A Vitals.checkType call received an invalid type ",m+="string. The value '"+e[t]+"' was incorrect. ",m+="Check Vitals.checkType's documentation for a ",m+="list of acceptable type strings.",Error(m);if(!u){if(null===m){m=z;u=r;e=!1;for(z=m.length;!e&&z--;)h||(u=
!a.test(m[z])),e=u;m=e}else{u=z;h=!1;for(z=u.length;!h&&z--;){e=u[z];if("any"===e){h=!0;break}if(c.test(e))h=k(m,e);else if(d.test(e))h=y(m,e);else if(b.test(e))if(h=m,v=r=t=void 0,Array.isArray(h))if("array"===e)h=!0;else{e=e.slice(0,-1);v="array"===e?Array.isArray:d.test(e)?y:k;r=!0;for(t=h.length;r&&t--;)r=v(h[t],e);h=r}else h=!1;else if(p.test(e))if(h=m,v=r=t=void 0,k(h,"object")){e=e.slice(0,-3);v="array"===e?Array.isArray:d.test(e)?y:k;r=!0;for(t in h)if(h.hasOwnProperty(t)&&(r=v(h[t],e),!r))break;
h=r}else h=!1}m=h}u=m}return u}}(k.allDataTypes,k.exceptLowerAlphaAndPipe);b.isValidTypeString=function(g,f){return function(a){var c,d;if("string"!==typeof a)throw new TypeError("A Vitals.isValidTypeString call received a non-string typeString param.");a=a.toLowerCase();a=a.replace(f,"");d=a.split("|");c=!0;for(a=d.length;c&&a--;)c=g.test(d[a]);return c}}(k.allDataTypes,k.exceptLowerAlphaAndPipe);b.checkArgs=function(g,f,a){return function(){var c,d,b,p,k,q,n;d=arguments.length;if(2>d||d%2)throw Error("A Vitals.checkArgs call was missing params.");
k=a.call(arguments,0);q=!0;for(c=-1;++c<d;)if(c%2){p=k[c];n=(n=g(p,"string",!0))&&f(p);if(!n)throw q=void 0,q="A Vitals.checkArgs call received an invalid type ",q+="string. The value '"+p+"' was incorrect. ",q+="Check Vitals.checkType's documentation for a ",q+="list of acceptable type strings.",Error(q);q=q&&g(b,p,!0)}else b=k[c];if(!q&&(p=w.checkArgsErrorMsg,(p=g(p,"string")?p:p())&&g(p,"string")))throw new TypeError(p);return q}}(b.checkType,b.isValidTypeString,Array.prototype.slice);b.getTypeOf=
function(g,f){return function(a){var c;c=typeof a;"object"===c&&g(a,"document|element|array")&&(c=null===a?"null":f(a)?"array":1===a.nodeType?"element":"document");return c}}(b.checkType,Array.isArray);b.freezeObj=function(g,f,a){var c=function(d){var b;a(d);for(b in d)!d.hasOwnProperty(b)||!f(d[b],"!object|function")||g&&d[b]instanceof RegExp||c(d[b])};return function(d,b){if(!f(d,"!object|function"))throw new TypeError("A Vitals.freezeObj call received an invalid obj param.");if(g&&d instanceof
RegExp)return d;!0===b?c(d):a(d);return d}}(y.freezeRegExpBug,b.checkType,Object.freeze);b.hasOwnProp=function(g){return function(b,a){if(!g(b,"object|function"))throw new TypeError("A Vitals.hasOwnProp call received an invalid obj param.");if(!g(a,"string|number")||""===a)throw new TypeError("A Vitals.hasOwnProp call received an invalid prop param.");return!!b&&b.hasOwnProperty(a)}}(b.checkType);y={};y.textContent="textContent"in n;Object.freeze(y);k={getElementsByClassNameAlt:function(g,b){var a,
c,d,l,p,k;if(b.querySelectorAll)l=b.querySelectorAll("."+g);else if(n.evaluate)for(l=[],d='"'+(" "+g+" ")+'")]',a=n.evaluate(d,b,null,0,null),d=a.iterateNext();d;)l.push(d),d=a.iterateNext();else for(k=new RegExp("(^|s)"+g+"(s|$)"),p=b.getElementsByTagName("*"),l=[],c=p.length,a=-1;++a<c;)d=p[a],k.test(d.className)&&l.push(d);return l}};b.freezeObj(k,!0);b.getElemById=function(g){if(!g||"string"!==typeof g)throw new TypeError("A Vitals.getElemById call received a non-string or empty string id param.");
return n.getElementById(g)};b.getElemByClass=function(g,b,a){return function(c,d,l){if(!g(c,"string")||""===c)throw new TypeError("A Vitals.getElemByClass call received a non-string or empty string classname param.");d=!g(d,"number")||-1>d?0:a(d);l&&g(l,"!element|document")||(l=w.getElemByClassRoot);c=l.getElementsByClassName?l.getElementsByClassName(c):b(c,l);if(0>d||d&&d>=c.length)d=c.length-1;return c.length?c[d]:null}}(b.checkType,k.getElementsByClassNameAlt,Math.floor);b.getElemsByClass=function(b,
f){return function(a,c){if(!b(a,"string")||""===a)throw new TypeError("A Vitals.getElemsByClass call received a non-string or empty string classname param.");c&&b(c,"!element|document")||(c=w.getElemsByClassRoot);return c.getElementsByClassName?c.getElementsByClassName(a):f(a,c)}}(b.checkType,k.getElementsByClassNameAlt);b.getElemByTag=function(b,f){return function(a,c,d){if(!b(a,"string")||""===a)throw new TypeError("A Vitals.getElemByTag call received a non-string or empty string tag param.");c=
!b(c,"number")||-1>c?0:f(c);d&&b(d,"!element|document")||(d=w.getElemByTagRoot);a=d.getElementsByTagName(a);if(0>c||c&&c>=a.length)c=a.length-1;return a.length?a[c]:null}}(b.checkType,Math.floor);b.getElemsByTag=function(b){return function(f,a){if(!b(f,"string")||""===f)throw new TypeError("A Vitals.getElemsByTag call received a non-string or empty string tag param.");a&&b(a,"!element|document")||(a=w.getElemsByTagRoot);return a.getElementsByTagName(f)}}(b.checkType);b.setElemText=function(b,f){return function(a,
c){var d;if(!b(a,"!element"))throw new TypeError("A Vitals.setElemText call received a non-element elem param.");if(!b(c,"string"))throw d="A Vitals.setElemText call received a non-string text param.",new TypeError(d);f?a.textContent=c:a.innerText=c;return a}}(b.checkType,y.textContent);b.makeElem=function(b,f){return function(a){var c;b(a,"string")?c=a:b(a,"!object")?c=a.tag||a.tagName:a=null;c=n.createElement(c||"div");a&&(a.text&&b(a.text,"string")&&f(c,a.text),a.html&&b(a.html,"string")&&(c.innerHTML=
a.html),a.id&&b(a.id,"string")&&(c.id=a.id),a.className&&b(a.className,"string")&&(c.className=a.className));return c}}(b.checkType,b.setElemText);b.addElemText=function(b,f){return function(a,c){var d;if(!b(a,"!element"))throw new TypeError("A Vitals.addElemText call received a non-element elem param.");if(!b(c,"string"))throw d="A Vitals.addElemText call received a non-string text param.",new TypeError(d);c&&(f?a.textContent+=c:a.innerText+=c);return a}}(b.checkType,y.textContent);b.set=function(b,
f,a,c){return function(d){var l;if(!b(d,"!object"))throw new TypeError("A Vitals.set call received an invalid settings param (should be an object).");for(l in w)f(w,l)&&f(d,l)&&(b(d[l],c[l])?w[l]=d[l]:a(l));return!0}}(b.checkType,b.hasOwnProp,function(b){var f;f="A Vitals.set call received an invalid "+b+" property for the settings param (the prop should be a ";f+=x.types[b]+").";throw new TypeError(f);},x.types);b.reset=function(b,f,a,c){return function(){var d,l,k;d=(d=arguments.length)?1<d?c.call(arguments,
0):b(arguments[0],"!array")?arguments[0]:[arguments[0]]:a(w);if(!b(d,"!strings"))throw new TypeError("A Vitals.reset call received an invalid setting param (should be a string or array of strings).");for(k=d.length;k--;)l=d[k],f(w,l)&&(w[l]=x[l]);return!0}}(b.checkType,b.hasOwnProp,Object.keys,Array.prototype.slice);return b}(window,document));
